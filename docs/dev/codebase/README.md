...
> 各模块的结构化文档索引。AI 助手和开发者在修改前先阅读相关模块文档，减少重复探索。
>
...
| 自动上号 | [account-auto-provision.md](account-auto-provision.md) | 分组阈值监控、备用账号补位、健康快照模板 | 2026-04-16 |
| 模型映射 | [model-mapping.md](model-mapping.md) | 模型白名单、映射配置、默认映射、网关解析、通配符 | 2026-04-12 |
| 计费系统 | [billing.md](billing.md) | 多级定价链、费用计算、费率乘数、缓存命中计费 | 2026-04-12 |

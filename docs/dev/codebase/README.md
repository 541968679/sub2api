...
| Ops | [ops.md](ops.md) | Admin operations dashboard, lightweight realtime projections, batched group capacity, Redis slot cleanup, availability alerting, Recovered list visibility (`include_recovered`), user/compare/schedule error-rate badges, and admin dual-sided upstream/downstream error display；生产 runbook 在 [../PRODUCTION.md](../PRODUCTION.md) | 2026-08-22 |

...
| 账号管理 | [account.md](account.md) | 账号 CRUD、Antigravity/Gemini OAuth、AI Credits、批量导入、OpenAI Claude-GPT bridge 账号绑定、账号级用户调度 allow/deny、账号/用户 last-N 质量格、质量硬关闭、账号错误率双口径与调度开关、用户智能调度账号池。选号策略见 [scheduler.md](scheduler.md) | 2026-08-28 |

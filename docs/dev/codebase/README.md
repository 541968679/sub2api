...
| API 网关 | [gateway.md](gateway.md) | 请求转发、负载均衡、熔断、SSE 流式、账号级用户调度过滤、Antigravity Claude-GPT bridge preflight、Codex remote compact V2 API-key 兜底、CC→Responses 同步缓冲超时与 API Key 非流式 JSON；bridge timeout 调查见 [../OPENAI_CLAUDE_GPT_BRIDGE_TIMEOUT_INVESTIGATION_2026-07-10.md](../OPENAI_CLAUDE_GPT_BRIDGE_TIMEOUT_INVESTIGATION_2026-07-10.md)；Grok/Codex 多轮与 OpenAI Key 跨平台 Grok 见 [../GROK_CODEX_AND_CROSS_PLATFORM_RESEARCH_2026-07-15.md](../GROK_CODEX_AND_CROSS_PLATFORM_RESEARCH_2026-07-15.md) | 2026-08-18 |

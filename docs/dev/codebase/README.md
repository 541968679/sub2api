...
| 账号管理 | [account.md](account.md) | 账号 CRUD、Antigravity/Gemini OAuth、AI Credits、批量导入、OpenAI Claude-GPT bridge 账号绑定、账号级用户调度 allow/deny、15 分钟质量快照、质量硬关闭、用户智能调度账号池 | 2026-08-18 |
...
| Ops | [ops.md](ops.md) | Admin operations dashboard, lightweight realtime projections, batched group capacity, Redis slot cleanup, availability alerting, and Recovered list visibility (`include_recovered`)；生产 runbook 在 [../PRODUCTION.md](../PRODUCTION.md) | 2026-08-18 |

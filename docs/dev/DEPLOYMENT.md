...
|------|-----|----------|-------|---------------|------|
| 2026-08-22 | `v0.1.251` | `52c2f91d1` | `ghcr.io/541968679/sub2api:0.1.251` | `0.1.251` | **current**; digest `sha256:095850c815a9755d2cbdf99418eb3787c9e540d590292a3afb6ce7441a735fe3`, `/health` ok, healthy; AG-pool OpenAI dual-membership + switch-off no-op + Ops raw upstream errors + PnL refresh; `v0.1.250` tag exists but GHCR was never published (`vue-tsc` resume grace fields); rollback digest `sha256:b4c0358520ecbe0157c826ad59b9ec704a9aa485c748877d4fc7f0ead95abb03` (`v0.1.249`) |

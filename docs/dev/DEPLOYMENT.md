...
|------|-----|----------|-------|---------------|------|
| 2026-09-01 | `v0.1.277` | `5dbe30c89` | `ghcr.io/541968679/sub2api:0.1.277` | `0.1.277` | **current**; digest `sha256:41910146722c35141bccf448bd714031bc48e2acb66b63d776452d4550483898`, `/health` ok, healthy; public-pool auto-sort current-page silent merge + interval-stable countdown (no `reload()` flash); rollback digest `sha256:7d2ccf51563c4d881c69523166b87060b51073f1889713058fda8a70eb28fe2f` (`v0.1.276`) |

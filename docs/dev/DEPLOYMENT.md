...
|------|-----|----------|-------|---------------|------|
| 2026-09-18 | `v0.1.291` | `a28185883` | `ghcr.io/541968679/sub2api:latest` (`0.1.291`) | `0.1.291` | **current**; digest `sha256:5a5f77ed251a35c09359eed0a5ab4b2c335e84dd64592fa0ae3261abf3ffb431`, `/health` ok, healthy; CCS import default-model picker title + `{site}-{key}` provider names; rollback digest `sha256:eafa1f502aa96e33804f44fceda9f780c5f14f6f2c73afefc24e2b3b1bb874e6` (`v0.1.290`) |

...
|------|-----|----------|-------|---------------|------|
| 2026-08-18 | `v0.1.240` | `e5608cdbe` | `ghcr.io/541968679/sub2api:latest` (`0.1.240`) | `0.1.240` | **current**; digest `sha256:ba60309580077e97fcd3e14313e57f2c2d5018d0662ad41ba1421148a9389221`, `/health` ok, healthy; CC→Responses fail-fast + API Key non-stream JSON; rollback digest `sha256:fb45fbf77ad49595f956c852d4fe8a5bba37a68f558f86587ccef2b7140ae362` (`v0.1.239`) |

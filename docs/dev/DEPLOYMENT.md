...
|------|-----|----------|-------|---------------|------|
| 2026-08-27 | `v0.1.266` | `4f004788d` | `ghcr.io/541968679/sub2api:latest` (`0.1.266`) | `0.1.266` | **current**; digest `sha256:c6fc31efea355c2e8f617ea62d0c655e79d9cda1888153327c238f607a074e6c`, `/health` ok, healthy; smart-schedule probe v2 + enter-AND/exit-OR + SoftEnd to selectable; rollback digest `sha256:f6bd8716156d657397ef67e795f1a8743cb7f1342a36df9937ed7f741b17b42d` (`v0.1.265`) |

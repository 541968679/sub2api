...
|------|-----|----------|-------|---------------|------|
| 2026-09-20 | `v0.1.295` | `58caa5c17` | `ghcr.io/541968679/sub2api:latest` (`0.1.295`) | `0.1.295` | **current**; digest `sha256:1bfbf5324a75a63e40880aa447e6dc2d66bf35f458c39a68f18c4a7025f39c28`, healthy; raw CC empty `model` fill + usage `upstream_response_model`; rollback digest `sha256:2b2fbc52bc70a1aa841619b18f9696f9ec924892baa5072d52c093e1d4670537` (`v0.1.294`) |

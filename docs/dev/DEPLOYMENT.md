...
|------|-----|----------|-------|---------------|------|
| 2026-08-31 | `v0.1.275` | `814e6430b` | `ghcr.io/541968679/sub2api:0.1.275` | `0.1.275` | **current**; digest `sha256:8536d43eae140a81a47ea6243179102a1d0b8953d1cd59b71770096203be2731`, `/health` ok, healthy; public-pool account-list auto-sort + manual sort (reserved-band `list_order`, skip `list_pinned`; no `priority` write); rollback digest `sha256:783ee9955212d35e2ef1d1bccc9a94a5ef9444c105ed8494dbdf3f18a62a5593` (`v0.1.274`) |

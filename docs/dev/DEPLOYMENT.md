...
|------|-----|----------|-------|---------------|------|
| 2026-09-15 | `v0.1.288` | `64aaecfcc` | `ghcr.io/541968679/sub2api:latest` (`0.1.288`) | `0.1.288` | **current**; digest `sha256:19e56249271d21dc7fb71f11dc84a8c946cbe96daa37eb5b52b521247f7083ed`, `/health` ok, healthy; user-level OpenAI wait timeout + billing nav/pricing; rollback digest `sha256:4b1ba478682aed55b29d4356875193ea4156843cac2d5ad508b53e41e3004a52` (`v0.1.287`) |

...
|------|-----|----------|-------|---------------|------|
| 2026-09-21 | `v0.1.297` | `90c540bff` | `ghcr.io/541968679/sub2api:latest` (`0.1.297`) | `0.1.297` | **current**; digest `sha256:2df62c3aae25b90218f2b66360645269f9613d7da149f867fde2496a9c44166b`, healthy; fill empty `model` on error-null / ping / NDJSON; rollback digest `sha256:14a98f22f3f07e351a6feeae69fd6780f036043d9db13e46e875096d2dd2ad83` (`v0.1.296`) |

...
|------|-----|----------|-------|---------------|------|
| 2026-08-11 | `v0.1.208` | `07d72e113` | `ghcr.io/541968679/sub2api:0.1.208` (override pin) | `0.1.208` | running, healthy, internal `/health` OK; Claude→GPT bridge PTL/compact lifecycle INFO logs; **still skips banned v0.1.199** |

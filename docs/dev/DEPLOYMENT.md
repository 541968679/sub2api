...
|------|-----|----------|-------|---------------|------|
| 2026-08-10 | `v0.1.206` | `2b4fa84a0` | `ghcr.io/541968679/sub2api:0.1.206` (override pin) | `0.1.206` | running, healthy, internal `/health` OK; admin user balance burn-rate column (opt-in, 5m window, 15s poll, $/h|/min); **still skips banned v0.1.199** |

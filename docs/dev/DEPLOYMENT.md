...
|------|-----|----------|-------|---------------|------|
| 2026-09-07 | `v0.1.284` | `bc62c3d0a` | `ghcr.io/541968679/sub2api:0.1.284` | `0.1.284` | **current**; digest `sha256:82d36356870a4361f04d4ef7a8f68da838d33447a73a40405f78cd53237e632b`, `/health` ok, healthy; Responses pre-output keepalive/control-frame failover (NewAPI output=1); rollback digest `sha256:822b410aa44aa2a33c0a7d1f0c936c7a737fc53775e1b20b5a07dc57ce301c2d` (`v0.1.283`) |

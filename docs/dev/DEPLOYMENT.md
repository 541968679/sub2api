...
|------|-----|----------|-------|---------------|------|
| 2026-09-21 | `v0.1.296` | `4e555e965` | `ghcr.io/541968679/sub2api:latest` (`0.1.296`) | `0.1.296` | **current**; digest `sha256:14a98f22f3f07e351a6feeae69fd6780f036043d9db13e46e875096d2dd2ad83`, healthy; Responses/WS + missing-field empty `model` fill; rollback digest `sha256:1bfbf5324a75a63e40880aa447e6dc2d66bf35f458c39a68f18c4a7025f39c28` (`v0.1.295`) |

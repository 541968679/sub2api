...
|------|-----|----------|-------|---------------|------|
| 2026-09-21 | `v0.1.298` | `fec7bec41` | `ghcr.io/541968679/sub2api:latest` (`0.1.298`) | `0.1.298` | **current**; digest `sha256:a262cb65dad709910d8b6e8c23306ffa761f22909916ea1f374fcdfc372a93e3`, healthy; admin channel load-test + customer SLA sheet preset; rollback digest `sha256:2df62c3aae25b90218f2b66360645269f9613d7da149f867fde2496a9c44166b` (`v0.1.297`) |

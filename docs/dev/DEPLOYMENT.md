...
|------|-----|----------|-------|---------------|------|
| 2026-09-19 | `v0.1.293` | `46081c9a8` | `ghcr.io/541968679/sub2api:latest` (`0.1.293`) | `0.1.293` | **current**; digest `sha256:cf4eb51585f4eaae88281f5063cd9b0f35b6153990b93737c85ffd159efc2f57`, `/health` ok, healthy; picker groups return actual upstream `/v1/models`; rollback digest `sha256:73ac3d1efee40c4c2a5788911b19e54e18fef72f1bd8ffe8946c93ea7e783473` (`v0.1.292`) |

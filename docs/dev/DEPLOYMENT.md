...
|------|-----|----------|-------|---------------|------|
| 2026-09-07 | `v0.1.286` | `5682fb816` | `ghcr.io/541968679/sub2api:0.1.286` | `0.1.286` | **current**; digest `sha256:56d234691e80450e11e910f74b1ac9a236b56b30b8fc5fe9a4007c6ca8061246`, `/health` ok, healthy; Ops last-hop provider_error_code (no hop-mix wait-timeout title); rollback digest `sha256:3385db40682cbad3570df5e8cb11627057336fdba789c84e576f03e25146dfd2` (`v0.1.285`) |

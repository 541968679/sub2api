...
|------|-----|----------|-------|---------------|------|
| 2026-08-22 | `v0.1.252` | `163b3f827` | `ghcr.io/541968679/sub2api:0.1.252` | `0.1.252` | **current**; digest `sha256:9a8a84da27d32fe94b19b7c9092049b89c001309b5fbda4a3a3981aa859f1526`, `/health` ok, healthy; AG pool hydrate keeps OpenAI dual-members (loveapi) after add/save/refresh (ids-only, no `platform=antigravity`); rollback digest `sha256:095850c815a9755d2cbdf99418eb3787c9e540d590292a3afb6ce7441a735fe3` (`v0.1.251`) |

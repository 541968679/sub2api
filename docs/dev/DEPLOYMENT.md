...
|------|-----|----------|-------|---------------|------|
| 2026-08-11 | `v0.1.207` | `098dbaefa` | `ghcr.io/541968679/sub2api:0.1.207` (override pin) | `0.1.207` | running, healthy, internal `/health` OK; admin OpenAI advanced scheduler weight override save persistence; **still skips banned v0.1.199** |

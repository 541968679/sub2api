...
|------|-----|----------|-------|---------------|------|
| 2026-09-26 | `v0.1.303` | `f50224079` | `ghcr.io/541968679/sub2api:latest` (`0.1.303`) | `0.1.303` | **current**; digest `sha256:de666b07b50f5735d617bd8c490271dc9d0893a57aa76a10b014630c731565e6`, healthy; custom `/v1/models` list wins over CCS picker and is loaded into the API-key auth snapshot; rollback digest `sha256:18ff1105316633d003bdde89bf16d9292e6eca0b4d163ea57b28d0a37cbdd029` (`v0.1.302`) |
| 2026-09-26 | `v0.1.302` | `2526dc0f0` | `ghcr.io/541968679/sub2api:latest` (`0.1.302`) | `0.1.302` | superseded by `v0.1.303`; digest `sha256:18ff1105316633d003bdde89bf16d9292e6eca0b4d163ea57b28d0a37cbdd029`, healthy; wider group custom `/v1/models` picker (extra candidates unchecked, hand-entered concrete IDs); rollback digest `sha256:92d30f1e8e98cb5ef1c12b75f3fdfac4f0ad565ddfa510bec0bee03816ad4804` (`v0.1.301`) |
| 2026-09-25 | `v0.1.301` | `3c554ee0d` | `ghcr.io/541968679/sub2api:latest` (`0.1.301`) | `0.1.301` | superseded by `v0.1.302`; digest `sha256:92d30f1e8e98cb5ef1c12b75f3fdfac4f0ad565ddfa510bec0bee03816ad4804`, healthy; channel loadtest tiers/general profile, Excel export dialog + units + timed filenames, api-mode auto-suggest; rollback digest `sha256:3c1b5ba68daea18c1a09f0a52e73043d3d23a40141644715247ff7daf59b286b` (`v0.1.300`) |
| 2026-09-23 | `v0.1.300` | `a455452ad` | `ghcr.io/541968679/sub2api:latest` (`0.1.300`) | `0.1.300` | superseded by `v0.1.301`; digest `sha256:3c1b5ba68daea18c1a09f0a52e73043d3d23a40141644715247ff7daf59b286b`, healthy; GPT-6 Sol / GPT-6 Luna / Claude Opus 5.5 catalog and billing; rollback digest `sha256:2bf9b09dab98109ee53515d34016f2ff13618f94128148641cec94251f281520` (`v0.1.299`) |
| 2026-09-22 | `v0.1.299` | `62b745254` | `ghcr.io/541968679/sub2api:latest` (`0.1.299`) | `0.1.299` | superseded by `v0.1.300`; digest `sha256:2bf9b09dab98109ee53515d34016f2ff13618f94128148641cec94251f281520`, healthy; kimi native chat completions, load-test success RPM / reasoning TTFT / token rates, admin usage t/s; rollback digest `sha256:a262cb65dad709910d8b6e8c23306ffa761f22909916ea1f374fcdfc372a93e3` (`v0.1.298`) |
| 2026-09-21 | `v0.1.298` | `fec7bec41` | `ghcr.io/541968679/sub2api:latest` (`0.1.298`) | `0.1.298` | superseded by `v0.1.299`; digest `sha256:a262cb65dad709910d8b6e8c23306ffa761f22909916ea1f374fcdfc372a93e3`, healthy; admin channel load-test + customer SLA sheet preset; rollback digest `sha256:2df62c3aae25b90218f2b66360645269f9613d7da149f867fde2496a9c44166b` (`v0.1.297`) |
| 2026-09-21 | `v0.1.297` | `90c540bff` | `ghcr.io/541968679/sub2api:latest` (`0.1.297`) | `0.1.297` | superseded by `v0.1.298`; digest `sha256:2df62c3aae25b90218f2b66360645269f9613d7da149f867fde2496a9c44166b`, healthy; fill empty `model` on error-null / ping / NDJSON; rollback digest `sha256:14a98f22f3f07e351a6feeae69fd6780f036043d9db13e46e875096d2dd2ad83` (`v0.1.296`) |
| 2026-09-21 | `v0.1.296` | `4e555e965` | `ghcr.io/541968679/sub2api:latest` (`0.1.296`) | `0.1.296` | superseded by `v0.1.297`; digest `sha256:14a98f22f3f07e351a6feeae69fd6780f036043d9db13e46e875096d2dd2ad83`, healthy; Responses/WS + missing-field empty `model` fill; rollback digest `sha256:1bfbf5324a75a63e40880aa447e6dc2d66bf35f458c39a68f18c4a7025f39c28` (`v0.1.295`) |
| 2026-09-20 | `v0.1.295` | `58caa5c17` | `ghcr.io/541968679/sub2api:latest` (`0.1.295`) | `0.1.295` | superseded by `v0.1.296`; digest `sha256:1bfbf5324a75a63e40880aa447e6dc2d66bf35f458c39a68f18c4a7025f39c28`, healthy; raw CC empty `model` fill + usage `upstream_response_model`; rollback digest `sha256:2b2fbc52bc70a1aa841619b18f9696f9ec924892baa5072d52c093e1d4670537` (`v0.1.294`) |
| 2026-09-19 | `v0.1.294` | `f4b497df7` | `ghcr.io/541968679/sub2api:latest` (`0.1.294`) | `0.1.294` | superseded by `v0.1.295`; digest `sha256:2b2fbc52bc70a1aa841619b18f9696f9ec924892baa5072d52c093e1d4670537`, healthy; auth path loads CCS picker flags so domestic `/v1/models` returns glm/kimi/etc; rollback digest `sha256:cf4eb51585f4eaae88281f5063cd9b0f35b6153990b93737c85ffd159efc2f57` (`v0.1.293`) |
| 2026-09-19 | `v0.1.293` | `46081c9a8` | `ghcr.io/541968679/sub2api:latest` (`0.1.293`) | `0.1.293` | superseded by `v0.1.294`; digest `sha256:cf4eb51585f4eaae88281f5063cd9b0f35b6153990b93737c85ffd159efc2f57`, `/health` ok, healthy; picker groups return actual upstream `/v1/models`; rollback digest `sha256:73ac3d1efee40c4c2a5788911b19e54e18fef72f1bd8ffe8946c93ea7e783473` (`v0.1.292`) |
| 2026-09-18 | `v0.1.292` | `8a88a1713` | `ghcr.io/541968679/sub2api:latest` (`0.1.292`) | `0.1.292` | superseded by `v0.1.293`; digest `sha256:73ac3d1efee40c4c2a5788911b19e54e18fef72f1bd8ffe8946c93ea7e783473`, `/health` ok, healthy; user billing-rules domestic tab + model-price search; plaza stays hidden via `model_plaza_enabled=false`; rollback digest `sha256:5a5f77ed251a35c09359eed0a5ab4b2c335e84dd64592fa0ae3261abf3ffb431` (`v0.1.291`) |
| 2026-09-18 | `v0.1.291` | `a28185883` | `ghcr.io/541968679/sub2api:latest` (`0.1.291`) | `0.1.291` | superseded by `v0.1.292`; digest `sha256:5a5f77ed251a35c09359eed0a5ab4b2c335e84dd64592fa0ae3261abf3ffb431`, `/health` ok, healthy; CCS import default-model picker title + `{site}-{key}` provider names; rollback digest `sha256:eafa1f502aa96e33804f44fceda9f780c5f14f6f2c73afefc24e2b3b1bb874e6` (`v0.1.290`) |
| 2026-09-17 | `v0.1.290` | `1810fe722` | `ghcr.io/541968679/sub2api:latest` (`0.1.290`) | `0.1.290` | superseded by `v0.1.291`; digest `sha256:eafa1f502aa96e33804f44fceda9f780c5f14f6f2c73afefc24e2b3b1bb874e6`, `/health` ok, healthy; CCS import picker (group-account upstream `/v1/models` union) + domestic catalogs; rollback digest `sha256:470ae539f97c014b4532c3fe02ccf6b6dca2495a1ce0e95ce1df0ad451827368` (`v0.1.289`) |
| 2026-09-17 | `v0.1.289` | `5e8c99832` | `ghcr.io/541968679/sub2api:latest` (`0.1.289`) | `0.1.289` | superseded by `v0.1.290`; digest `sha256:470ae539f97c014b4532c3fe02ccf6b6dca2495a1ce0e95ce1df0ad451827368`, `/health` ok, healthy; isolation 0.2.4 A-tier overlay + wait-timeout SQL 250; rollback digest `sha256:19e56249271d21dc7fb71f11dc84a8c946cbe96daa37eb5b52b521247f7083ed` (`v0.1.288`) |
| 2026-09-15 | `v0.1.288` | `64aaecfcc` | `ghcr.io/541968679/sub2api:latest` (`0.1.288`) | `0.1.288` | superseded by `v0.1.289`; digest `sha256:19e56249271d21dc7fb71f11dc84a8c946cbe96daa37eb5b52b521247f7083ed`, `/health` ok, healthy; user-level OpenAI wait timeout + billing nav/pricing; rollback digest `sha256:4b1ba478682aed55b29d4356875193ea4156843cac2d5ad508b53e41e3004a52` (`v0.1.287`) |
| 2026-09-07 | `v0.1.287` | `55f887fb4` | `ghcr.io/541968679/sub2api:0.1.287` | `0.1.287` | superseded by `v0.1.288`; digest `sha256:4b1ba478682aed55b29d4356875193ea4156843cac2d5ad508b53e41e3004a52`, `/health` ok, healthy; native Responses large-preamble pendingLines (NewAPI empty-output); rollback digest `sha256:56d234691e80450e11e910f74b1ac9a236b56b30b8fc5fe9a4007c6ca8061246` (`v0.1.286`) |
| 2026-09-07 | `v0.1.286` | `5682fb816` | `ghcr.io/541968679/sub2api:0.1.286` | `0.1.286` | superseded by `v0.1.287`; digest `sha256:56d234691e80450e11e910f74b1ac9a236b56b30b8fc5fe9a4007c6ca8061246`, `/health` ok, healthy; Ops last-hop provider_error_code (no hop-mix wait-timeout title); rollback digest `sha256:3385db40682cbad3570df5e8cb11627057336fdba789c84e576f03e25146dfd2` (`v0.1.285`) |
| 2026-09-07 | `v0.1.285` | `e9b5589b0` | `ghcr.io/541968679/sub2api:0.1.285` | `0.1.285` | superseded by `v0.1.286`; digest `sha256:3385db40682cbad3570df5e8cb11627057336fdba789c84e576f03e25146dfd2`, `/health` ok, healthy; wait-timeout hops stop after one extra account; rollback digest `sha256:82d36356870a4361f04d4ef7a8f68da838d33447a73a40405f78cd53237e632b` (`v0.1.284`) |
| 2026-09-07 | `v0.1.284` | `bc62c3d0a` | `ghcr.io/541968679/sub2api:0.1.284` | `0.1.284` | superseded by `v0.1.285`; digest `sha256:82d36356870a4361f04d4ef7a8f68da838d33447a73a40405f78cd53237e632b`, `/health` ok, healthy; Responses pre-output keepalive/control-frame failover (NewAPI output=1); rollback digest `sha256:822b410aa44aa2a33c0a7d1f0c936c7a737fc53775e1b20b5a07dc57ce301c2d` (`v0.1.283`) |
| 2026-09-06 | `v0.1.283` | `06fb2d3d1` | `ghcr.io/541968679/sub2api:0.1.283` | `0.1.283` | superseded by `v0.1.284`; digest `sha256:822b410aa44aa2a33c0a7d1f0c936c7a737fc53775e1b20b5a07dc57ce301c2d`, `/health` ok, healthy; JSON import fallback mapping + clickable smart-pool membership/admission; rollback digest `sha256:b2570a2505c1e21a3508426cff52e16a582a3e8cac6ad17a8eba2ae502768da9` (`v0.1.282`) |
| 2026-09-06 | `v0.1.282` | `d509b6ca0` | `ghcr.io/541968679/sub2api:0.1.282` | `0.1.282` | superseded by `v0.1.283`; digest `sha256:b2570a2505c1e21a3508426cff52e16a582a3e8cac6ad17a8eba2ae502768da9`, `/health` ok, healthy; user model pricing platform tabs + bulk LiteLLM suggested fill; rollback digest `sha256:19e7fdbe2e93ab60c9a84978e75324b5dbe0184cbf2f6a17b3a3fc68885920dd` (`v0.1.281`) |
| 2026-09-05 | `v0.1.281` | `498f6c5c8` | `ghcr.io/541968679/sub2api:0.1.281` | `0.1.281` | superseded by `v0.1.282`; digest `sha256:19e7fdbe2e93ab60c9a84978e75324b5dbe0184cbf2f6a17b3a3fc68885920dd`, `/health` ok, healthy; OpenAI capacity-shed pre-output failover + Codex `server_error` rewrite; rollback digest `sha256:33f84ad65cd145fc8255b7588df4ab7fc740ecdd4d6ebd190bd294302f8bc3c7` (`v0.1.280`) |
| 2026-09-05 | `v0.1.280` | `331054cbf` | `ghcr.io/541968679/sub2api:0.1.280` | `0.1.280` | superseded by `v0.1.281`; digest `sha256:33f84ad65cd145fc8255b7588df4ab7fc740ecdd4d6ebd190bd294302f8bc3c7`, `/health` ok, healthy; editable OpenAI model catalog + `gpt-6-astra` seed; rollback digest `sha256:c1d3838b3f72d588a9f4eeff5c78bbc3e9d1b2d92e58fbc9a7cac00ac1810b7c` (`v0.1.279`) |
| 2026-09-04 | `v0.1.279` | `006a34822` | `ghcr.io/541968679/sub2api:0.1.279` | `0.1.279` | superseded by `v0.1.280`; digest `sha256:c1d3838b3f72d588a9f4eeff5c78bbc3e9d1b2d92e58fbc9a7cac00ac1810b7c`, `/health` ok, healthy; ChatGPT sessionToken refresh for Codex session import; rollback digest `sha256:c155a8a51b9fb47282396d36a6c7845af84eb77ae7a70929cdbd5f0f1add9eac` (`v0.1.278`) |
| 2026-09-04 | `v0.1.278` | `3bd7ca6e2` | `ghcr.io/541968679/sub2api:0.1.278` | `0.1.278` | superseded by `v0.1.279`; digest `sha256:c155a8a51b9fb47282396d36a6c7845af84eb77ae7a70929cdbd5f0f1add9eac`, `/health` ok, healthy; last-N Recovered/failover contrast counts with a single hop TTFT clock; rollback digest `sha256:41910146722c35141bccf448bd714031bc48e2acb66b63d776452d4550483898` (`v0.1.277`) |
| 2026-09-01 | `v0.1.277` | `5dbe30c89` | `ghcr.io/541968679/sub2api:0.1.277` | `0.1.277` | superseded by `v0.1.278`; digest `sha256:41910146722c35141bccf448bd714031bc48e2acb66b63d776452d4550483898`, `/health` ok, healthy; public-pool auto-sort current-page silent merge + interval-stable countdown (no `reload()` flash); rollback digest `sha256:7d2ccf51563c4d881c69523166b87060b51073f1889713058fda8a70eb28fe2f` (`v0.1.276`) |
| 2026-09-01 | `v0.1.276` | `61da3e567` | `ghcr.io/541968679/sub2api:0.1.276` | `0.1.276` | superseded by `v0.1.277`; digest `sha256:7d2ccf51563c4d881c69523166b87060b51073f1889713058fda8a70eb28fe2f`, `/health` ok, healthy; hide OpenAI wait-timeout markers from downstream clients (Ops keeps `openai_header_wait_timeout` / `openai_first_useful_frame_timeout`); rollback digest `sha256:8536d43eae140a81a47ea6243179102a1d0b8953d1cd59b71770096203be2731` (`v0.1.275`) |
| 2026-08-31 | `v0.1.275` | `814e6430b` | `ghcr.io/541968679/sub2api:0.1.275` | `0.1.275` | superseded by `v0.1.276`; digest `sha256:8536d43eae140a81a47ea6243179102a1d0b8953d1cd59b71770096203be2731`, `/health` ok, healthy; public-pool account-list auto-sort + manual sort (reserved-band `list_order`, skip `list_pinned`; no `priority` write); rollback digest `sha256:783ee9955212d35e2ef1d1bccc9a94a5ef9444c105ed8494dbdf3f18a62a5593` (`v0.1.274`) |
| 2026-08-30 | `v0.1.274` | `0f0b39b2d` | `ghcr.io/541968679/sub2api:0.1.274` | `0.1.274` | superseded by `v0.1.275`; digest `sha256:783ee9955212d35e2ef1d1bccc9a94a5ef9444c105ed8494dbdf3f18a62a5593`, `/health` ok, healthy; copy-from-user smart-schedule pool + account-list upstream-rate sort/bulk select (includes `0.1.273`); rollback digest `sha256:c8e3e7550d98bae2ca43e1fc9ceb868b70f08b07cbf643d5617bbe332a1688d4` (`v0.1.272`) |
| 2026-08-29 | `v0.1.272` | `9f550e0b4` | `ghcr.io/541968679/sub2api:0.1.272` | `0.1.272` | superseded by `v0.1.274`; digest `sha256:c8e3e7550d98bae2ca43e1fc9ceb868b70f08b07cbf643d5617bbe332a1688d4`, `/health` ok, healthy; public-quality site card 1+2 (full EvalQuality knobs, height-matched) + Codex `invalid_encrypted_content` compaction retry; rollback digest `sha256:2dae3a9ff0ddd85f48fa572319f16f5ce85c785789658a8adfd0e5cc3ec2fdca` (`v0.1.271`) |
| 2026-08-29 | `v0.1.271` | `c52599b3e` | `ghcr.io/541968679/sub2api:0.1.271` | `0.1.271` | superseded by `v0.1.272`; digest `sha256:2dae3a9ff0ddd85f48fa572319f16f5ce85c785789658a8adfd0e5cc3ec2fdca`, `/health` ok, healthy; public-schedule quality (site card off by default, six-state column, K/C on quality cell, 7d LiteLLM cycle, unbind-by-rate); `v0.1.270` tag exists but GHCR never published (vue-tsc); rollback digest `sha256:102460d427ae5640700d4490471cb51c1c106b937a6b293ff498d5251d0ecaa8` (`v0.1.269`) |
| 2026-08-28 | `v0.1.269` | `64936cce0` | `ghcr.io/541968679/sub2api:0.1.269` | `0.1.269` | superseded by `v0.1.271`; digest `sha256:102460d427ae5640700d4490471cb51c1c106b937a6b293ff498d5251d0ecaa8`, `/health` ok, healthy; display-only p95 on account/pair quality cells (same TTFT slice as shown p50; not used for gates/K/C/hard-close); rollback digest `sha256:fca07f611daa146dc04b0e9d2642494e685822054858dae2c42f17528d481829` (`v0.1.268`) |
| 2026-08-28 | `v0.1.268` | `c057c0f44` | `ghcr.io/541968679/sub2api:latest` (`0.1.268`) | `0.1.268` | superseded by `v0.1.269`; digest `sha256:fca07f611daa146dc04b0e9d2642494e685822054858dae2c42f17528d481829`, `/health` ok, healthy; OpenAI header-wait + first-useful-frame timeout (committed hops abort with client error, no silent switch); rollback digest `sha256:94653ebc47b538199ee3c68b610992eddb6256dfe2e472b8e4c9a4dbe5fb16f7` (`v0.1.267`) |
| 2026-08-27 | `v0.1.267` | `d7ec3a7e2` | `ghcr.io/541968679/sub2api:latest` (`0.1.267`) | `0.1.267` | superseded by `v0.1.268`; digest `sha256:94653ebc47b538199ee3c68b610992eddb6256dfe2e472b8e4c9a4dbe5fb16f7`, `/health` ok, healthy; pair p50 from any TTFT sample (empty phase alias no longer blanks live FIFO); rollback digest `sha256:c6fc31efea355c2e8f617ea62d0c655e79d9cda1888153327c238f607a074e6c` (`v0.1.266`) |
| 2026-08-27 | `v0.1.266` | `4f004788d` | `ghcr.io/541968679/sub2api:latest` (`0.1.266`) | `0.1.266` | superseded by `v0.1.267`; digest `sha256:c6fc31efea355c2e8f617ea62d0c655e79d9cda1888153327c238f607a074e6c`, `/health` ok, healthy; smart-schedule probe v2 + enter-AND/exit-OR + SoftEnd to selectable; rollback digest `sha256:f6bd8716156d657397ef67e795f1a8743cb7f1342a36df9937ed7f741b17b42d` (`v0.1.265`) |
| 2026-08-27 | `v0.1.265` | `b93f54e26` | `ghcr.io/541968679/sub2api:latest` (`0.1.265`) | `0.1.265` | superseded by `v0.1.266`; digest `sha256:f6bd8716156d657397ef67e795f1a8743cb7f1342a36df9937ed7f741b17b42d`, `/health` ok, healthy; skip audio/realtime in OpenAI capability probe + admin `all_apikeys` reprobe; rollback digest `sha256:eab116716c02138c8fd05003ccd4c3ea851dfa99a3358f9ee21b44310e7a6aaa` (`v0.1.264`) |
| 2026-08-26 | `v0.1.264` | `cc49a5f06` | `ghcr.io/541968679/sub2api:latest` (`0.1.264`) | `0.1.264` | superseded by `v0.1.265`; digest `sha256:eab116716c02138c8fd05003ccd4c3ea851dfa99a3358f9ee21b44310e7a6aaa`, `/health` ok, healthy; selectable K/C/p50 independently opt-in; rollback digest `sha256:8a21a72b8a36601a734124c5772c7c5e839a37c4f200eb760d3e9cef1c6afee8` (`v0.1.263`) |
| 2026-08-26 | `v0.1.263` | `38b23436f` | `ghcr.io/541968679/sub2api:latest` (`0.1.263`) | `0.1.263` | superseded by later releases; digest `sha256:8a21a72b8a36601a734124c5772c7c5e839a37c4f200eb760d3e9cef1c6afee8`, `/health` ok, healthy; New API wallet + subscription remaining on admin balance cells; pair schedule-PnL dialog splits wallet/subscription; also ships unpushed `8e868d615` sched K/C pair-quality cells; rollback digest `sha256:0fa343ea0520e6ebe895b03daf24cd1c51dc71eebdad24186131350f48691d31` (`v0.1.262`) |
| 2026-08-26 | `v0.1.262` | `859f9c4ca` | `ghcr.io/541968679/sub2api:0.1.262` | `0.1.262` | superseded by `v0.1.263`; digest `sha256:0fa343ea0520e6ebe895b03daf24cd1c51dc71eebdad24186131350f48691d31`, `/health` ok, healthy; sched cache keeps N/K/C + soft pair cooldown; after recreate `DEL smart-schedule:user:16` then Lookup refill (`quality_sched_window_n=10`, `quality_sched_max_slow_in_window=3`, `quality_sched_max_consecutive_slow=2`, `quality_max_p50_duration_ms=80000`); rollback digest `sha256:905e11fc91ac151a4c362806e36ba5665929c4626ad6d597faeda73f8153c73c` (`v0.1.261`) |
| 2026-08-24 | `v0.1.257` | `6745f4b38` | `ghcr.io/541968679/sub2api:latest` (`0.1.257`) | `0.1.257` | superseded by later releases (`v0.1.261` was live before `v0.1.262`); digest `sha256:2bb576e03205f6c902d70d895a13618ff547b3b25ec45ad4b8f17dc6c8178e81`, `/health` ok, healthy; overflow sticky one-shot return to cheaper peer + unpooled WaitPlan overflow; per-user Q_u window N/P95; display joint input+cache cap; OAuth fleet soft 429; pair TTFT/success N split; NewAPI user-wallet balance; OpenAI long-context billing toggle; rollback digest `sha256:60e166b38bb1896dd18cd49777487c57d3a4370d366f3a15643269d06ae3d7f2` (`v0.1.256`) |
| 2026-08-23 | `v0.1.256` | `02af57230` | `ghcr.io/541968679/sub2api:latest` (`0.1.256`) | `0.1.256` | superseded by `v0.1.257`; digest `sha256:60e166b38bb1896dd18cd49777487c57d3a4370d366f3a15643269d06ae3d7f2`, `/health` ok, healthy; pair-slot live occupancy (90s window + process prefix) + hydrate keeps openai/antigravity shard; rollback digest `sha256:e368c03aeb083c99d591721854bf48a39d4d1efbc99bdc27f29928ec433e1c49` (`v0.1.255`) |
| 2026-08-23 | `v0.1.255` | `98103b688` | `ghcr.io/541968679/sub2api:latest` (`0.1.255`) | `0.1.255` | superseded by `v0.1.256`; digest `sha256:e368c03aeb083c99d591721854bf48a39d4d1efbc99bdc27f29928ec433e1c49`, `/health` ok, healthy; custom schedule error whitelist from logs + `form.custom` vue-tsc fix; `v0.1.254` tag exists but GHCR never published (`form.custom` possibly undefined); rollback digest `sha256:26810812421caf29cfe677551f4c83e022c65816ff80a4da273edc21750af8d7` (`v0.1.253`) |
| 2026-08-23 | `v0.1.253` | `38d0a4036` | `ghcr.io/541968679/sub2api:0.1.253` | `0.1.253` | superseded by `v0.1.255`; digest `sha256:26810812421caf29cfe677551f4c83e022c65816ff80a4da273edc21750af8d7`, `/health` ok, healthy; Claude-GPT bridge full history replay for API keys; rollback digest `sha256:9a8a84da27d32fe94b19b7c9092049b89c001309b5fbda4a3a3981aa859f1526` (`v0.1.252`) |
| 2026-08-22 | `v0.1.252` | `163b3f827` | `ghcr.io/541968679/sub2api:0.1.252` | `0.1.252` | superseded by `v0.1.253`; digest `sha256:9a8a84da27d32fe94b19b7c9092049b89c001309b5fbda4a3a3981aa859f1526`, `/health` ok, healthy; AG pool hydrate keeps OpenAI dual-members (loveapi) after add/save/refresh (ids-only, no `platform=antigravity`); rollback digest `sha256:095850c815a9755d2cbdf99418eb3787c9e540d590292a3afb6ce7441a735fe3` (`v0.1.251`) |
| 2026-08-22 | `v0.1.251` | `52c2f91d1` | `ghcr.io/541968679/sub2api:0.1.251` | `0.1.251` | superseded by `v0.1.252`; digest `sha256:095850c815a9755d2cbdf99418eb3787c9e540d590292a3afb6ce7441a735fe3`, `/health` ok, healthy; AG-pool OpenAI dual-membership + switch-off no-op + Ops raw upstream errors + PnL refresh; `v0.1.250` tag exists but GHCR was never published (`vue-tsc` resume grace fields); rollback digest `sha256:b4c0358520ecbe0157c826ad59b9ec704a9aa485c748877d4fc7f0ead95abb03` (`v0.1.249`) |
| 2026-08-20 | `v0.1.245` | `872951282` | `ghcr.io/541968679/sub2api:0.1.245` | `0.1.245` | superseded by later releases (`v0.1.249` was live before `v0.1.251`); digest `sha256:17f79f1e15cab372386fa3237a6974fa2337c6a3bb05760b64f8da5851e13ef3`, `/health` ok, healthy; pair-full no WaitPlan + wait-wake pair attach; quality cell failover/Recovered comparison success rate (display only); rollback digest `sha256:1cae09a00e3b35f91fcdf34726bb2c3d0b9f78a246ef796689ecc948ec79edb7` (`v0.1.244`) |

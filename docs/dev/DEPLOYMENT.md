...
|------|-----|----------|-------|---------------|------|
| 2026-09-26 | `v0.1.302` | `2526dc0f0` | `ghcr.io/541968679/sub2api:latest` (`0.1.302`) | `0.1.302` | **current**; digest `sha256:18ff1105316633d003bdde89bf16d9292e6eca0b4d163ea57b28d0a37cbdd029`, healthy; wider group custom `/v1/models` picker (extra candidates unchecked, hand-entered concrete IDs); rollback digest `sha256:92d30f1e8e98cb5ef1c12b75f3fdfac4f0ad565ddfa510bec0bee03816ad4804` (`v0.1.301`) |

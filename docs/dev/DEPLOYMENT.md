...
|------|-----|----------|-------|---------------|------|
| 2026-09-18 | `v0.1.292` | `8a88a1713` | `ghcr.io/541968679/sub2api:latest` (`0.1.292`) | `0.1.292` | **current**; digest `sha256:73ac3d1efee40c4c2a5788911b19e54e18fef72f1bd8ffe8946c93ea7e783473`, `/health` ok, healthy; user billing-rules domestic tab + model-price search; plaza stays hidden via `model_plaza_enabled=false`; rollback digest `sha256:5a5f77ed251a35c09359eed0a5ab4b2c335e84dd64592fa0ae3261abf3ffb431` (`v0.1.291`) |

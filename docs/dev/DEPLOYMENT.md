...
|------|-----|----------|-------|---------------|------|
| 2026-09-01 | `v0.1.276` | `61da3e567` | `ghcr.io/541968679/sub2api:0.1.276` | `0.1.276` | **current**; digest `sha256:7d2ccf51563c4d881c69523166b87060b51073f1889713058fda8a70eb28fe2f`, `/health` ok, healthy; hide OpenAI wait-timeout markers from downstream clients (Ops keeps `openai_header_wait_timeout` / `openai_first_useful_frame_timeout`); rollback digest `sha256:8536d43eae140a81a47ea6243179102a1d0b8953d1cd59b71770096203be2731` (`v0.1.275`) |

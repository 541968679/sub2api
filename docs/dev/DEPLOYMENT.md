...
|------|-----|----------|-------|---------------|------|
| 2026-08-30 | `v0.1.274` | `0f0b39b2d` | `ghcr.io/541968679/sub2api:0.1.274` | `0.1.274` | **current**; digest `sha256:783ee9955212d35e2ef1d1bccc9a94a5ef9444c105ed8494dbdf3f18a62a5593`, `/health` ok, healthy; copy-from-user smart-schedule pool + account-list upstream-rate sort/bulk select (includes `0.1.273`); rollback digest `sha256:c8e3e7550d98bae2ca43e1fc9ceb868b70f08b07cbf643d5617bbe332a1688d4` (`v0.1.272`) |

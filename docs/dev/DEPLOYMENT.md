...
|------|-----|----------|-------|---------------|------|
| 2026-09-17 | `v0.1.289` | `5e8c99832` | `ghcr.io/541968679/sub2api:latest` (`0.1.289`) | `0.1.289` | **current**; digest `sha256:470ae539f97c014b4532c3fe02ccf6b6dca2495a1ce0e95ce1df0ad451827368`, `/health` ok, healthy; isolation 0.2.4 A-tier overlay + wait-timeout SQL 250; rollback digest `sha256:19e56249271d21dc7fb71f11dc84a8c946cbe96daa37eb5b52b521247f7083ed` (`v0.1.288`) |

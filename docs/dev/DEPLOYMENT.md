...
|------|-----|----------|-------|---------------|------|
| 2026-09-04 | `v0.1.279` | `006a34822` | `ghcr.io/541968679/sub2api:0.1.279` | `0.1.279` | **current**; digest `sha256:c1d3838b3f72d588a9f4eeff5c78bbc3e9d1b2d92e58fbc9a7cac00ac1810b7c`, `/health` ok, healthy; ChatGPT sessionToken refresh for Codex session import; rollback digest `sha256:c155a8a51b9fb47282396d36a6c7845af84eb77ae7a70929cdbd5f0f1add9eac` (`v0.1.278`) |

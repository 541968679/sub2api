<template>
  ...
  <svg v-else-if="platform === 'kimi' || platform === 'zhipu' || platform === 'deepseek' || platform === 'minimax'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 3l2.4 6.9H22l-5.7 4.2 2.2 6.9L12 16.8 5.5 21l2.2-6.9L2 9.9h7.6L12 3z" />
  </svg>

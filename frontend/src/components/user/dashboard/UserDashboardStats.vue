      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xs text-gray-500 dark:text-gray-400">
            ...
            <template v-if="(stats?.today_cache_creation_tokens || 0) + (stats?.today_cache_read_tokens || 0) > 0">
              <br />Cache: {{ formatTokens((stats?.today_cache_creation_tokens || 0) + (stats?.today_cache_read_tokens || 0)) }}
            </template>
          </p>
        </div>
      </div>
      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xs text-gray-500 dark:text-gray-400">
            ...
            <template v-if="(stats?.total_cache_creation_tokens || 0) + (stats?.total_cache_read_tokens || 0) > 0">
              <br />Cache: {{ formatTokens((stats?.total_cache_creation_tokens || 0) + (stats?.total_cache_read_tokens || 0)) }}
            </template>
          </p>
        </div>
      </div>

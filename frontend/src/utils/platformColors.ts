...
const BADGE: Record<Platform, string> = {
  ...
  grok: 'bg-zinc-500/10 text-zinc-700 border-zinc-500/30 dark:text-zinc-300',
}
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  grok: 'bg-zinc-500/10 text-zinc-700 dark:bg-zinc-500/10 dark:text-zinc-300',
}
...
const BORDER: Record<Platform, string> = {
  ...
  grok: 'border-zinc-500/20 dark:border-zinc-500/20',
}
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  grok: 'bg-gradient-to-r from-zinc-500 to-cyan-600',
}
...
const ICON: Record<Platform, string> = {
  ...
  grok: 'text-zinc-600 dark:text-zinc-300',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  grok: 'bg-zinc-700 text-white hover:bg-zinc-800 active:bg-black dark:bg-zinc-600 dark:hover:bg-zinc-500',
}
...
const GRADIENT: Record<Platform, string> = {
  ...
  grok: 'from-zinc-600 to-cyan-600',
}

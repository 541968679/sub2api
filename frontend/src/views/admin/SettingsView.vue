                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                  ...
                  <div>
                    ...
                    <Select
                      :modelValue="rule.action"
                      @update:modelValue="
                        rule.action = $event as 'pass' | 'filter' | 'block' | 'force_priority'
                      "
        ...
        <div class="card">
          ...
          <div class="space-y-5 p-6">
            ...
            <div v-if="form.cyber_session_block_enabled">
              ...
              <input v-model.number="form.cyber_session_block_ttl_seconds" class="input max-w-xs" type="number" min="1" />
            </div>
          </div>
        </div>
...
const form = reactive<SettingsForm>({
  ...
  payment_bonus_tiers: [] as { min_amount: number; bonus_usd: number }[],
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      payment_bonus_tiers: form.payment_bonus_tiers || [],

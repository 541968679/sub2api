...
describe('UserSmartScheduleView', () => {
  ...
  it('uses a compact header, two cards, and a full-width pool table', async () => {
    ...
    expect(thresholdGrid.get('[data-testid="smart-schedule-wait-timeout-group"]').exists()).toBe(true)
    expect(thresholdGrid.get('[data-testid="smart-schedule-header-wait"]').exists()).toBe(true)
    expect(thresholdGrid.get('[data-testid="smart-schedule-first-useful-frame"]').exists()).toBe(true)

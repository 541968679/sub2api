...
const allColumns = computed<Column[]>(() => [
  ...
  { key: 'total_consumed', label: t('admin.subscriptions.columns.totalConsumed'), sortable: true },
  { key: 'avg_daily', label: t('admin.subscriptions.columns.avgDaily'), sortable: true },
  { key: 'usage_rate', label: t('admin.subscriptions.columns.usageRate'), sortable: true },

  ...
  admin: {
    ...
    users: {
      ...
      smartSchedule: {
        ...
        maxSlowInWindowHint: 'Probe phase: when the TTFT window is full, this many samples above threshold triggers cooldown (formerly K). Empty with a first-token median configured applies default 2.',
        maxConsecutiveSlow: 'Consecutive slow samples',
        maxConsecutiveSlowHint: 'Probe phase: this many consecutive samples above threshold at the end triggers cooldown, even under-full (formerly C). Empty with a first-token median configured applies default 2.',
        schedWindowN: 'Window size',
        schedWindowNHint: 'Selectable TTFT/duration window length. Only the median waits for a full window. Empty keeps legacy median-only; filling enables the composite gate (defaults 20/6/3).',
        schedMaxSlowInWindow: 'Slow samples in window',
        schedMaxSlowInWindowHint: 'Selectable: ready once this many slow samples exist — do not wait for a full window (formerly K). Empty does not enable the composite gate.',
        schedMaxConsecutiveSlow: 'Consecutive slow samples',
        schedMaxConsecutiveSlowHint: 'Selectable: ready once this many consecutive tail samples are slow — do not wait for a full window (formerly C). Empty does not enable the composite gate.',
        ...
        pairQualityHint: 'This user × this account’s last-N windows: TTFT p50, success rate, and each window count / its own N. Click for the pair trend and cooldown / exemption / selectable events. This is not the account last-N quality cell.',

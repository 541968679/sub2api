  ...
  admin: {
    ...
    users: {
      ...
      smartSchedule: {
        ...
        windowN: 'Window size N',
        windowNHint: 'Split into TTFT N and success N. At launch both start equal to this user’s previous single N.',
        windowNTtft: 'TTFT N',
        windowNTtftHint: 'Last-N first-token samples for this user × this account. Same value is the window length and the open-judgment floor (1–100, default 10). Under N does not cool on TTFT. At launch this starts equal to the user’s current N.',
        windowNSuccess: 'Success N',
        windowNSuccessHint: 'Last-N success/failure completions for this user × this account. Same value is the window length and the open-judgment floor (1–100, default 10). Under N does not cool on success rate. Probe follow-N uses this. At launch this starts equal to the user’s current N.',
        probeConcurrency: 'Probe concurrency',
        probeConcurrencyHint:
          'In-flight cap during probing. Follow success N uses this policy’s success N (not TTFT N, not account-quality N). If the account has a pair cap, occupancy is still min(selected, cap).',
        probeConcurrencyFollowN: 'Follow success N',
        ...
        pairOccupancyProbingHint: 'Probe concurrency is min(selected, pair cap), or the selected value when uncapped. Follow N uses window N. Not 999 and not unlimited.',

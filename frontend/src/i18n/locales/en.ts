  ...
  admin: {
    ...
    users: {
      ...
      smartSchedule: {
        ...
        addRegionHint: 'Search and add one account, or open the filter dialog to preview candidates with account-list filters. Membership edits still need Save.',
        ...
        addFilteredSuccess: 'Added {count} accounts. Click Save to apply.',
        ...
        pairCap: 'Pair cap',
        pairCapHint: 'This user’s pair cap on this account. Blank means no extra cap and pair Redis slots are not acquired. When a cap exists, the badge is current / pair cap. Cap edits need Save.',
        ...
        dirtyBanner: 'Unsaved pool membership, pair-cap, or threshold edits. Auto-refresh will not overwrite this draft; click Save to apply.',
        dirtySaveHint: 'Membership and pair caps still need Save',
        ...
        autoSort: 'Auto-sort',
        autoSortHint:
          'Reorders current-platform pool members by admission → pair headroom → account concurrency → existing priority → LRU, then writes account priorities immediately (lower number is preferred, same as Claude / same-rate OpenAI). Does not sort by upstream rate; the hot path already applies that overlay. Does not remove members.',
        autoSortProgress: 'Writing priorities {done}/{total}…',
        autoSortSuccess: 'Wrote auto-sort priorities for {count} accounts',
        autoSortUnchanged: 'Priorities already match auto-sort; nothing to write',
        autoSortPartial: 'Wrote priorities for {written} accounts; {failed} failed',
        autoSortFailed: 'Failed to write auto-sort priorities',
        refresh: 'Refresh',

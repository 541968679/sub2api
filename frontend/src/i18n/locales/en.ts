  ...
  admin: {
    ...
    users: {
      ...
      smartSchedule: {
        ...
        admissionWillCool: 'Will cool on next request',
        admissionWillCoolHint: 'The saved pair-quality gate already fails, but pair cooldown has not been written yet. The next selected request will start cooldown.',

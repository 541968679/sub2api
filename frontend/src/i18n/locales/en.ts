  ...
  admin: {
    ...
    accounts: {
      ...
      userSchedule: {
        ...
        qualityNoPauseHint: 'User gates have no pause timer: the pair is excluded while the live window misses, and admitted again as soon as it recovers. Click Resume now to admit the user without clearing the gate.',

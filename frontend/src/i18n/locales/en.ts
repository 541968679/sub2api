  ...
  admin: {
    ...
    users: {
      ...
      smartSchedule: {
        ...
        schedWindowNHint: 'Selectable phase TTFT/duration evaluation window. Slow-sample and median gates require a full window. Empty with a first-token median configured applies default 20.',
        schedMaxSlowInWindow: 'Slow samples in window',
        schedMaxSlowInWindowHint: 'Selectable phase: when the window is full, slow count ≥ this value triggers cooldown (formerly K). Empty with a first-token median configured applies default 6.',
        schedMaxConsecutiveSlow: 'Consecutive slow samples',
        schedMaxConsecutiveSlowHint: 'Selectable phase: this many consecutive slow samples at the end of a full window trigger cooldown; no under-full consecutive rule (formerly C). Empty with a first-token median configured applies default 3.',

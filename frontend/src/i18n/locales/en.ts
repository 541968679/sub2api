const enBase = {
  ...
  admin: {
    ...
    accounts: {
      ...
      clearConcurrency: 'Clear concurrency slots',
      clearConcurrencySuccess: 'Cleared concurrency slots (was {slots})',
      clearConcurrencyFailed: 'Failed to clear concurrency slots',
    ...
    usage: {
      ...
      cacheShareRealOnly: 'Cache share real {real}',
      cacheShareBoth: 'Cache share real {real} · display {display}',

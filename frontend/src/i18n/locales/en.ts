const enBase = {
  ...
  admin: {
    ...
    modelPricing: {
      ...
      // Inline edit hints
      inlineEditHint: 'Tip: click a price value in the table to edit it quickly. Edit the billing basis in the channel settings above.',
      ...
      billingBasisColumnNote: 'The "Mapping Role" column is a read-only label derived from the mapping relationship. The actual billing basis is controlled by the channel the request goes through.',
      channelBillingBasisTitle: 'Channel Billing Basis',
      channelBillingBasisHint: 'Controls whether requests through each channel look up pricing by the requested model name or the mapped model name.',
      channelBillingBasisNoChannels: 'No channels found',
      channelBillingBasisSaved: 'Channel billing basis saved',
      channelBillingBasisLegacyUpstream: 'Legacy value is bill by final upstream model. Saving changes it to bill by mapped model.',
      billingModelSourceRequested: 'By requested model',
      billingModelSourceChannelMapped: 'By mapped model',
      // New split columns + billing mode column
      requestedModelName: 'Requested Model',
      upstreamModelName: 'Mapped Model',
      billingMode: 'Mapping Role',

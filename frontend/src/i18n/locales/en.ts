  ...
  admin: {
    ...
    users: {
      ...
      smartSchedule: {
        ...
        pairCap: 'Pair cap',
        pairCapHint: 'This user’s concurrency on this account. The number is the cap (blank = no extra cap); the badge is current / effective max. Cap edits need Save.',

  ...
  admin: {
    ...
    accounts: {
      ...
      accountSchedule: {
        ...
        smartPoolHint: 'See which users have this account, add or remove membership, and switch the same six admission states. Adding does not enable that user×platform. Changes save immediately and are not part of modal Save.',
        poolStatus: 'Pool status',
        addUser: 'Add user',
        remove: 'Remove',
        removeSelected: 'Remove selected',
        empty: 'No users on this platform have this account in their smart pool yet.',

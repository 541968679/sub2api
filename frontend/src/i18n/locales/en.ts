  ...
  admin: {
    ...
    users: {
      ...
      smartSchedule: {
        ...
        resumeSuccess: 'Pair cooldown cleared',
        ...
        admissionHint: 'Whether this user can be picked from this pool — not the account status. Cooldown, pair-full, stopped scheduling, and quality blocks all exclude the pair.',
        ...
        admissionQualityBlocked: 'Quality blocked',

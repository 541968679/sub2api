  ...
  admin: {
    ...
    accounts: {
      ...
      userSchedule: {
        ...
        modeDeny: 'Deny list',
        hint: 'Allow list, deny list, and pair concurrency are independent and may overlap. Deny wins over allow. Unset caps keep the current account + user global limits only.',
        allowHint: 'When nonempty, only listed users can be scheduled onto this account.',
        denyHint: 'A listed user cannot be scheduled; pair caps are ignored.',
        concurrencyHint: 'Max concurrent requests for this user on this account. Empty or 0 means no pair cap. Minimum explicit value is 1.',
        capOnly: 'Pair cap only',
        capOnlyHint: 'A user can have a pair cap without being on the allow or deny list.',
        ...
        overwriteHint: 'When checked, overwrites that list on the selected accounts (does not merge). Bulk edit never writes pair caps.',
        deleted: 'Deleted',

const enBase = {
  ...
  admin: {
    ...
    modelConfig: {
      ...
      catalog: {
        hint: 'The OpenAI curated list is what ordinary /v1/models returns. The default whitelist is the non-strict scheduling fallback. Saving merges newly added whitelist identity keys into OpenAI accounts that already have a mapping (passthrough and empty mappings are skipped). Grok IDs are not auto-added to the whitelist.',
        displayTitle: 'Curated display list',
        displayHint: 'Ordinary GET /v1/models returns these IDs. The Codex official catalog is unchanged.',
        whitelistTitle: 'Default whitelist',
        whitelistHint: 'Non-strict accounts can still be scheduled for these models when they are missing from account mapping. Whitelist-only IDs (for example gpt-image-2) never appear on /v1/models.',
        add: 'Add',
        addPlaceholder: 'Model ID, e.g. gpt-6-astra',
        save: 'Save',
        saving: 'Saving...',
        confirmSave: 'This will write new whitelist identity keys onto {count} OpenAI accounts that already have a mapping. Save now?',

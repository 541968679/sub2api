  ...
  admin: {
    ...
    users: {
      ...
      smartSchedule: {
        ...
        pairQualityHint: 'This user × this account’s last-N window: TTFT p50, success rate, and both window counts / N. Click for the pair trend and cooldown / exemption / selectable events. This is not the account 15-minute quality cell.',
        ...
        pairTrendEmptyHint: 'Pair quality is recalculated when a sample enters the window. This is not the account 5-minute quality history.',
        pairEventsTitle: 'Cooldown / exemption / selectable',
        ...
        switchStateHint: 'Manually switch this pair among paused, cooldown, exemption period, and selectable',
        ...
        admissionHint: 'Whether this user can be picked from this pool — not the account status. Pause and pair cooldown are live locks. A saved pair-quality miss without a cooldown is “will cool on next request”; an unsaved or disabled gate is a preview, not a lock.',
        ...
        admissionResumedHint: 'During the exemption period this pair is not judged and will not enter cooldown. Judgment resumes after it ends.',
    ...
    accounts: {
      ...
      userSchedule: {
        ...
        qualityGateHint: 'When this account’s live 15-minute TTFT/success rate misses the user’s thresholds, stop scheduling this account to that user only. Unset metrics are ignored; under-sampled metrics are not judged.',
        ...
        qualityNoPauseHint: 'User gates have no pause timer: the pair is excluded while the live window misses. Resume now shows Resumed. Click Resumed, or wait 15 minutes, to return to Quality and start a new window. The gate is not cleared.',
        ...
        qualityWindowStartSuccess: 'A new 15-minute quality window has started',
        qualityGateChip: 'Quality',
        qualityBlockedChip: 'Blocked',
        qualityBlockedChipTitle: 'The live 15-minute window misses this user’s gate, so this account is not scheduled to them',
        qualityResumedChip: 'Resumed',
        qualityResumedChipTitle: 'This user is admitted. Click again to start a new 15-minute window, or wait 15 minutes to start automatically.',
      ...
      stability: {
        ...
        resumeHint: 'You do not have to wait out the pause. If the current 15-minute window still misses, the next evaluation (about 5 minutes) may pause it again.',
        ...
        useGlobalHint: 'Turn off to override thresholds, sample floors, and the and/or condition',
        ...
        failoverToggleHint:
          'Off by default: smart-schedule gates and hard-close keep the current caliber (client status ≥ 400, model-not-found already excluded). Turn on to count this account’s Recovered 429/503 in ErrorCount. The switch is stored on the site-wide quality template, not only in the browser. List numbers refresh immediately; selection uses the next 5-minute quality tick.',

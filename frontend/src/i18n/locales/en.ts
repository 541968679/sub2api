  ...
  admin: {
    ...
    accounts: {
      ...
      userSchedule: {
        ...
        modeDeny: 'Deny list',
        hint: 'Allow list, deny list, and per-user concurrency are independent and may overlap. Deny wins over allow. Unset caps keep the current account + user global limits only.',
        ...
        restoreDefaultHint: 'Clear the allow list, deny list, and pair caps',
        enableWrite: 'Write user schedule',
        enableAllowWrite: 'Overwrite allow list',
        enableDenyWrite: 'Overwrite deny list',
        overwriteHint: 'When checked, overwrites that list on the selected accounts (does not merge). Bulk edit never writes per-user concurrency caps.',
        deleted: 'Deleted',
    ...
    settings: {
      ...
      qualityHardClose: {
        ...
        description: 'Master switch and default threshold template. Saving this card does not enable any account; open the stability window to turn an account on.',
        ...
        templateHint: 'Accounts that use the system template inherit these thresholds. Saving this card does not enable any account.',
        maxP50: 'Max p50 TTFT (ms)',
        minSuccessRate: 'Min success rate (%)',

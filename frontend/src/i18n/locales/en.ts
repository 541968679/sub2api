const enBase = {
  ...
  admin: {
    ...
    channelLoadtest: {
      title: 'Load Test',
      description: 'Run high-concurrency OpenAI Chat Completions against an upstream, score TTFT/TPOT, and flag empty model fields',
      source: 'Target',
      ...
      sheetPresetHint: 'Fills 50×50K, 38×80K, 10×160K, and 2×380K. You can edit the rows. Output limit is the current max_tokens, not the paired 200/600/1300/7000. Clear the table to use preset sampling again. Size cap is cleared.',
      tiers: 'Traffic tiers',
      tierInput: 'Input tokens',
      tierCount: 'Count',
      addTier: 'Add tier',
      removeTier: 'Remove',
      clearTiers: 'Clear tiers',
      tierHint: 'This run sends {n} requests from the tier table. Output limit is the current max_tokens. Total, size cap, and fixed input are not used.',
      ...
      inputTokens: 'Fixed input tokens',
      inputTokensHint: '0 = sample from the preset. 50000 runs every request at ~50K to test the p50 gate.',
      ...
      sizeCap: 'Context cap',
      sizeCapHint: '0 means uncapped; SLA p99 input is 380K',
      tools: 'Tools',

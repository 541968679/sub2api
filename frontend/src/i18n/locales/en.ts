  ...
  admin: {
    ...
    users: {
      ...
      smartSchedule: {
        ...
        windowNHint: 'Last N completed samples for this user × this account. Both the TTFT and success windows use this one N (1–100, default 10). A window under N does not cool on that metric.',
        probeConcurrency: 'Probe concurrency',
        probeConcurrencyHint:
          'In-flight cap during probing. Follow N uses this policy’s window N (not account-quality N). If the account has a pair cap, occupancy is still min(selected, cap).',
        probeConcurrencyFollowN: 'Follow N',
        ...
        pairQualityHint: 'This user × this account’s last-N window: TTFT p50, success rate, and both window counts / N. Click for the pair trend and cooldown / exemption / selectable events. This is not the account last-N quality cell.',
        ...
        pairWindowCounts: 'TTFT {ttft}/{n} · OK {ok}/{n}',

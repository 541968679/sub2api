const zhBase = {
  ...
  admin: {
    ...
    channelLoadtest: {
      title: '并发压测',
      description: '按客户画像对 OpenAI 兼容上游做高并发 Chat Completions 压测，统计 TTFT / TPOT，并检查空 model 字段',
      source: '测试目标',
      sourceAccount: '选择账号',
      sourceManual: '手填 API',
      account: '账号',
      ...
      sheetPresetHint: '填入 50×50K、38×80K、10×160K、2×380K，可再改。填表后输出上限用当前 max_tokens，不再按 200/600/1300/7000 配对。清空档位后才走原来的抽样。上下文上限会清零。',
      tiers: '流量档位',
      tierInput: '输入 tokens',
      tierCount: '条数',
      addTier: '添加档位',
      removeTier: '删除',
      clearTiers: '清空档位',
      tierHint: '本次按档位表发送 {n} 条。输出上限使用当前 max_tokens。总请求数、上下文上限和固定输入这次不参与。',
      tierInvalid: '每一档都要填写 1–400000 的整数输入 token，以及至少 1 条。最多 64 档，条数合计不超过 500。',
      appliedTiers: '本次档位',
      inputTokens: '固定输入 tokens',
      inputTokensHint: '0=按预设抽样。填 50000 则全部按约 50K 输入测 p50 门槛。',
      inputBand: '输入分档',
      ...
      apiModeKimiHint: 'kimi-k3 只接受原生 /v1/chat/completions。即使这里选了 Responses，kimi 模型也会改成 Chat Completions 再发出。',
      streamMode: '流式',
      streamModeAuto: '跟随画像',
      ...
      sizeCap: '上下文上限',
      sizeCapHint: '0 表示不封顶；SLA 画像 p99 为 380K',
      tools: 'Tools',

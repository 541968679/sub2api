  ...
  admin: {
    ...
    users: {
      ...
      smartSchedule: {
        ...
        windowN: '窗口样本数 N',
        windowNHint: '已拆成 N首字 / N成功率。上线时两值先等于该用户原来的单一 N。',
        windowNTtft: 'N首字',
        windowNTtftHint: '该用户×该账号最近 N 条首字样本，同时是窗长和开判门槛。范围 1–100，默认 10。未满不因首字冷却。上线时先等于该用户当前 N。',
        windowNSuccess: 'N成功率',
        windowNSuccessHint: '该用户×该账号最近 N 条成功/失败完成样本，同时是窗长和开判门槛。范围 1–100，默认 10。未满不因成功率冷却。考察并发跟随此项。上线时先等于该用户当前 N。',
        probeConcurrency: '考察并发',
        probeConcurrencyHint:
          '考察期进行中上限；跟随成功率 N 时等于 N成功率（不是 N首字，也不是账号质量 N）。若该账号设了配对 cap，实际占用仍不超过 cap（min(所选, cap)）。',
        probeConcurrencyFollowN: '跟随成功率 N',
        ...
        pairOccupancyProbingHint: '考察并发：min(所选, 配对上限)，未设上限则为所选。跟随 N 时所选等于窗口 N。不是 999，也不是无限。',
        uncappedPair: '不额外限制',

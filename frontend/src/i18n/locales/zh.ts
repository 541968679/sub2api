const zhBase = {
  ...
  keyUsage: {
    title: 'API Key 用量查询',
    subtitle: '无需登录，输入 API Key 查看用量记录与统计',
    apiKeyLabel: 'API Key',
    ...
    switchToDark: '切换到深色模式',
    awaitingQuery: '等待查询',
    emptyBeforeQuery: '输入 API Key 后查询用量记录。',
    dateRange: '统计范围:',
    dateRangeToday: '今日',
    dateRange7d: '7 天',
    dateRange30d: '30 天',
  ...
  nav: {
    ...
    channelLoadtest: '并发压测',
    channelStatus: '渠道状态',
    riskControl: '风控中心',
    costAnalysis: '成本分析',
    costSubscriptionProfit: '包月成本/利润',
  },
  ...
  costAnalysis: {
    subscriptionProfit: {
      title: '包月成本 / 利润',
      description: '按订阅统计包月 / 日限用户的真实成本、收入与利润倍数',
      onlyPaidNote: '默认展示全部匹配订阅；付费订单计入收入，兑换码 / 管理员 / 默认分配会标注来源且收入按 0 计',
      purchasePrice: '进货单价',
      purchasePriceUnit: '元 / 百万 token',
      purchasePriceHint: '按 token 平价进货成本，默认 0.25（≈ ¥10 / 4000万 token）',
      startDate: '开始日期',
      endDate: '结束日期',
      rangeHint: '按订阅开始日期筛选',
      activeOnly: '仅当前有效订阅',
      activeHint: '默认展示当前有效订阅在订阅期内的消耗',
      costMode: '成本口径',
      unitPerMtok: '元 / 百万 token',
      unitPerDollar: '元 / 刀',
      refresh: '刷新',
      loading: '加载中…',
      empty: '暂无符合条件的订阅',
  ...
  usage: {
    ...
    cycleClickHint: '点击查看各期 L$ 与窗口内 A$ 曲线、表格',
    cycleHistoryTitle: 'Codex 7 日周期消耗',
    cycleHistoryHint: '表格与曲线按该号 Codex 7 日窗口统计。L$ 是 LiteLLM 标价 × 真实 token；窗口内 A$ 用与列表 A$ 相同的账号计费公式，但按周期起止而不是滚动 7 个自然日。窗口已过期时列表 L$ 为 $0，弹层仍展示该窗口内已发生的消耗。',
    cycleChartTitle: '各期消耗',
    cycleTableTitle: '各期明细',
    cycleCurrent: '当前',
    cycleClosed: '已结束',
    cycleWindow: '窗口',
    cycleLiteLLM: 'L$',
    ...
    cycleTokens: 'Token',
    cycleEmpty: '还没有周期记录',
    cycleEmptyHint: '等本窗口结束后会留下上期；更早的期次也列在这里。',
    cycleLoadFailed: '加载周期历史失败',
    resetNow: '现在',
    resetPending: '待刷新',
    ...
    cacheHitTitle: '缓存命中率',
    cacheCreationRate: '创建率',
    cacheRequestHitRate: '请求命中率',
    cacheHitHint: '读取率 = 缓存读取 /（输入 + 缓存读取 + 缓存创建）。注意：Antigravity 不上报缓存创建，OpenAI bridge 的缓存读取可能为展示覆盖值；跨平台混合时仅供参考，建议按分组筛选到单一平台查看。',
    perRequest: '每次请求',
    apiKeyFilter: 'API 密钥',
    allApiKeys: '全部密钥',
    timeRange: '时间范围',
    ...
    latencyDuration: '总耗时',
    inputPerSecond: '入 {n} t/s',
    outputPerSecond: '出 {n} t/s',
    inputPerSecondColumn: '输入 t/s',
    outputPerSecondColumn: '输出 t/s',
    tokenRateHint: 'token 数 ÷ 这次请求的总耗时（秒），四舍五入。与 new-api 使用记录的 t/s 同一口径，输入也按总耗时计算。',
    time: '时间',
    ws: 'WS',
    stream: '流式',
    sync: '同步',
  ...
  redeem: {
    ...
    codeRule2: '兑换码可以增加余额，或开通/延长订阅',
    codeRule3: '如有兑换问题，请联系客服',
    codeRule4: '余额和订阅会在兑换成功后立即更新',
    recentActivity: '最近活动',
  ...
  admin: {
    ...
    users: {
      ...
      unpin: '取消置顶',
      pinnedSuccess: '已置顶',
      unpinnedSuccess: '已取消置顶',
      failedToPin: '更新置顶状态失败',
      editUser: '编辑用户',
      deleteUser: '删除用户',
      ...
      subscriptionGroupsHint: '访问由订阅控制；此处仅配置该用户对该订阅分组的专属/展示倍率。',
      noSubscriptionGroups: '该用户暂无关联的订阅分组',
      defaultRate: '默认倍率',
      customRate: '专属倍率',
      displayRate: '展示倍率',
      ...
      balanceHistoryManage: '充值记录管理',
      balanceHistoryManageTitle: '充值记录管理',
      balanceHistoryManageHint: '删除仅移除变动记录，不会回滚用户余额或并发数',
      deleteBalanceHistoryRecord: '删除记录',
      deleteBalanceHistoryConfirm: '确定要删除该充值/并发变动记录吗？此操作无法撤销，且不会回滚用户余额或并发数。',
      deleteBalanceHistoryConfirmDetail: '确定删除「{title} {value}」这条记录吗？删除后无法撤销，且不会回滚用户余额或并发数。',
      deleteBalanceHistorySuccess: '变动记录已删除',
      failedToDeleteBalanceHistory: '删除变动记录失败',
      ...
      smartSchedule: {
        menuItem: '智能调度',
        title: '用户智能调度',
        pageDescription: '按平台配置该用户的质量门槛、冷却和账号池。',
        backToUsers: '返回用户列表',
        unknownUser: '未知用户',
        platform: '平台',
        poolTitle: '{platform} 账号池',
        ...
        enabledOn: '已开启',
        enabledOff: '未开启',
        enabledHint: '开启后该平台是封闭白名单。池为空时不能开启；删光成员会自动关闭并回到现网调度。',
        enabledSwitchHint: '打开即对该平台生效，无需再点保存。池为空时不能开启。',
        enableSuccess: '已开启该平台智能调度',
        disableSuccess: '已关闭该平台智能调度',
        windowN: '窗口条数',
        windowNHint: '已拆成首字窗口与成功率窗口。上线时两值先等于该用户原来的单一窗口条数。',
        windowNTtft: '首字窗口条数',
        windowNTtftHint: '该用户×该账号最近首字样本条数，同时是窗长和开判门槛。范围 1–100，默认 10。未满窗不因首字冷却。上线时先等于该用户当前窗口条数。',
        ...
        probeLatencyV2On: 'v2',
        probeLatencyV2Hint:
          '开启后，冷却结束或手选考察先做考察预检：用该账号上其他人在最近冷却分钟内的完成样本，按与正式考察同一套成功率 / 首字 / 耗时规则判定。通过则直接进调度，失败再冷却，不够样本才正式考察。关闭则保持现网 257。',
        schedPhaseGroup: '调度期',
        maxP50Ttft: '首字中位数（ms）',
        maxP50Duration: '非流式耗时中位数（ms）',
        maxP50DurationHint: '非流式完成请求的 duration_ms 窗口中位数上限（毫秒）。留空则跳过 duration 门；与首字窗独立、共用窗口/超标规则。',
        maxSlowInWindow: '窗口内超标条数',
        maxSlowInWindowHint: '考察期：样本达到 K 且超标条数 ≥ K 即冷却（先到先评，不等满 N）。留空且已配首字或耗时门槛时默认 2。',
        maxConsecutiveSlow: '连续超标条数',
        maxConsecutiveSlowHint: '考察期：样本达到 C 且末尾 C 条都超标即冷却（先到先评）。留空且已配首字或耗时门槛时默认 2。',
        schedWindowN: '窗口条数',
        schedWindowNHint: '调度期（可调度）首字/耗时评定窗口长度，只约束中位数：满此条数才评 p50。留空则中位数用考察期首字窗。',
        schedMaxSlowInWindow: '窗口内超标条数',
        schedMaxSlowInWindowHint: '调度期：填写后才评 K。满此条数超标即冷却，不必满窗口。留空不启用 K。',
        schedMaxConsecutiveSlow: '连续超标条数',
        schedMaxConsecutiveSlowHint: '调度期：填写后才评 C。末尾连续此条数均超标即冷却，不必满窗口。留空不启用 C。',
        probeConcurrency: '考察并发',
        probeConcurrencyHint:
          '考察期进行中上限；跟随成功率窗口时等于成功率窗口条数（不是首字窗口，也不是账号质量窗口）。若该账号设了配对 cap，实际占用仍不超过 cap（min(所选, cap)）。',
        probeConcurrencyFollowN: '跟随成功率窗口',
        ...
        pairSuccessShort: '成功',
        pairWindowLabel: '窗口条数',
        pairWindowCounts: '首字 {ttft}/{nTtft} · 成功 {ok}/{nOk}',
        pairLatencyKC: 'K {slow}/{k} · C {consec}/{c}',
        pairLatencyK: 'K {slow}/{k}',
        pairLatencyC: 'C {consec}/{c}',
        pairTrendTitle: '配对窗口趋势',
        pairTrendEmpty: '暂无配对窗口快照',
        pairTrendEmptyHint: '配对质量每完成一条入窗后重算。这里不是账号 last-N 质量历史。',
        pairEventsTitle: '冷却 / 考察 / 豁免期 / 可调度',
        pairEventsEmpty: '暂无该配对的冷却或豁免期事件',
        ...
        pairEventExpiryZero: '窗口清零',
        pairEventSoftCooldownEnd: '软冷却提前结束',
        cooldown: '配对冷却（分钟）',
        cooldownModeHard: '硬',
        cooldownModeSoft: '软',
        cooldownModeHardHint: '必须等到冷却分钟数后才进入考察。手选配对冷却同样硬等。',
        cooldownModeSoftHint: '冷却期内，本平台池其他号的完成样本按调度期门槛齐样且过线后，可提前进入考察（含手选冷却）。',
        admissionSoft: '软',
        copyFrom: '从其他平台复制',
        copy: '复制配置',
        copySuccess: '已复制开关、门槛和冷却，未复制账号池',
        copyFailed: '复制智能调度配置失败',
        copyFromUser: '从其他用户复制',
        copyFromUserTitle: '从其他用户复制当前平台策略',
        copyFromUserSearch: '搜索源用户',
        copyFromUserSearchPlaceholder: '输入邮箱或用户名',
        copyFromUserEmptySearch: '没有匹配的用户',
        copyFromUserNoUser: '请选择源用户',
        copyFromUserSlicePool: '账号池（含暂停）',
        copyFromUserSliceConcurrency: '配对并发',
        copyFromUserSliceSortOrder: '池内顺序',
        copyFromUserSliceThresholds: '质量门槛和冷却',
        copyFromUserSliceEnabled: '平台开关',
        copyFromUserPreviewAdd: '将加入 {count} 个账号',
        copyFromUserPreviewRemove: '将移出 {count} 个账号',
        copyFromUserPreviewOverlap: '重叠 {count} 个账号',
        copyFromUserPreviewSkipped: '跳过 {count} 个不可用账号',
        copyFromUserPreviewPaused: '源侧暂停 {count} 个账号',
        copyFromUserEnabledEnable: '将开启平台开关',
        copyFromUserEnabledDisable: '将关闭平台开关',
        copyFromUserEnabledUnchanged: '开关不变',
        copyFromUserEmptySource: '源用户该平台没有可用账号，无法复制账号池',
        copyFromUserStale: '源配置已变化，请刷新预览',
        copyFromUserDirty: '请先保存或丢弃未保存的修改',
        copyFromUserDiscardDirty: '丢弃当前平台未保存的修改并继续？',
        copyFromUserConfirm: '确认复制',
        copyFromUserSuccess: '已从其他用户复制当前平台策略',
        copyFromUserFailed: '从其他用户复制失败',
        addAccount: '快速加入',
        addAccountPlaceholder: '输入账号名称搜索',
        addAccountSearchPlaceholder: '输入账号名称',
        addAccountEmpty: '没有匹配的账号',
        add: '加入',
        addRegionTitle: '添加账号',
        addRegionHint: '快速搜索加入单个账号，或打开筛选弹窗按账号管理条件预览后批量加入。加入后立即生效。',
        filteredAdd: '筛选添加',
        ...
        addAllMatching: '加入全部匹配 ({count})',
        addFilteredSuccess: '已加入 {count} 个账号',
        filterRegionTitle: '筛选池内账号',
        filterRegionHint: '只过滤当前平台池里已经加入的账号，不影响添加候选。',
        filterSchedulingAll: '当前调度（全部）',
        filterSchedulingOn: '正在调度',
        filterSchedulingOff: '当前未调度',
        filterProxyAll: '全部代理',
        filterProxyNone: '无代理',
        addScheduling: '一键加入当前调度',
        addSchedulingApi: 'API ({count})',
        addSchedulingOauth: 'OAuth ({count})',
        addSchedulingAll: '全部 ({count})',
        addSchedulingSuccess: '已加入 {count} 个当前调度账号',
        addSchedulingNone: '没有可加入的当前调度账号',
        applyCap: '统一配对并发',
        applyCapButton: '应用到本平台全部',
        pairCap: '配对并发',
        pairCapHint: '该用户在此账号上的并发上限。空/0 表示不额外限制（保存语义不变，不是 999 上限）。徽章分子是该用户在此账号上的实时占用；未设上限时分母固定为 999，仅用于展示。有上限时徽章是占用 / 配对上限。改上限后需点保存。',
        pairOccupancyUncappedHint: '未设上限：徽章是该用户占用 / 999（仅展示，不是真实上限）',
        pairOccupancyProbingHint: '考察并发：min(所选, 配对上限)，未设上限则为所选。跟随成功率窗口时所选等于成功率窗口条数。不是 999，也不是无限。',
        uncappedPair: '不额外限制',
        removeFromPool: '移出账号池',
        emptyPool: '开启智能调度前请先加入至少一个账号',
        emptyPoolHint: '该平台账号池为空。开启前请加入账号。',
        resume: '立即恢复',
        resumeCooling: '冷却中，立即恢复',
        resumeWillCool: '写入豁免期，期内不判断配对质量',
        ...
        switchSuccessSelectable: '已切到可调度：窗口已清零，重新攒满窗口条数后才会冷却（无时间豁免）',
        ...
        cancel: '取消',
        loadFailed: '加载智能调度失败',
        updateSuccess: '智能调度已更新',
        updateFailed: '更新智能调度失败',
        ...
        admissionPairFull: '配对已满',
        admissionStopped: '已停止调度',
        admissionWillCool: '将写入冷却',
        admissionWillCoolHint: '当前配对质量已不达标。完成请求时会写入冷却，不必等到下次选中。',
        pairMetricsPhaseProbe: '考察窗',
        pairMetricsPhaseSched: '调度窗',
        pairMetricsPhaseSoft: '软冷却窗',
        admissionUnsavedPreview: '未保存预览',
        ...
        filterSearch: '搜索池内账号',
        filterSchedulableAll: '调度开关（全部）',
        filterSchedulableOn: '账号可调度',
        filterSchedulableOff: '账号不可调度',
        filterAdmissionAll: '入池状态（全部）',
        bulkTitle: '批量操作当前筛选',
        selectAllOauth: '选中全部 OAuth',
        selectAllApikey: '选中全部 API Key',
        batchPaused: '暂停',
        batchSelectable: '可调度',
        batchProbing: '考察',
        batchAdmissionConfirm: '将把 {count} 个账号设为{state}，仅对该用户生效。确定继续？',
        batchAdmissionSuccess: '已将 {count} 个账号设为{state}',
        batchRemove: '移出账号池',
        batchApplyCap: '应用配对并发',
        manualSort: '排序（手动）',
        manualSortHint:
          '立即按入池状态 → 本用户是否出量（配对占用>0） → 上游倍率（低优先） → 配对剩余 → 账号并发 → 原账号优先级（只读平局） → id 重排当前平台池成员，并写入池内顺序 1..N。不改账号调度优先级。不改热路径选号。不删成员。',
        autoSort: '自动排序（隔几秒自动）',
        enableAutoSort: '启用自动排序',
        autoSortCountdown: '自动排序：{seconds}s',
        autoSortIntervalHint:
          '自动排序（隔几秒自动）。跟随自动刷新的间隔：每次自动刷新完成后，按与手动排序相同的规则静默写入池内顺序。单独开启不会另起计时。不改账号调度优先级。不改热路径选号。',
        autoSortHint:
          '按入池状态 → 本用户是否出量（配对占用>0） → 上游倍率（低优先） → 配对剩余 → 账号并发 → 原账号优先级（只读平局） → id 重排当前平台池成员，并立即写入池内顺序 1..N。手动排序立即写一次；自动排序跟随自动刷新，刷新后再按同一规则写一次。不改账号调度优先级。不改热路径选号。不删成员。',
        autoSortProgress: '正在写入池内顺序…',
        autoSortSuccess: '已按自动排序写入 {count} 个账号的池内顺序',
        autoSortUnchanged: '当前池内顺序已符合自动排序，无需写入',
    ...
    imageChannelMonitor: {
      title: '图片渠道监控',
      description: '定期请求 OpenAI 兼容生图接口，并统计 API 与返图下载阶段耗时',
      searchPlaceholder: '搜索图片监控...',
      allSources: '全部来源',
      allStatus: '全部状态',
      sourceCustom: '自定义 API',
      sourceAccount: 'API 账号',
      onlyEnabled: '仅启用',
      onlyDisabled: '仅禁用',
      createButton: '新增图片监控',
      createTitle: '新增图片渠道监控',
      editTitle: '编辑图片渠道监控',
      runNow: '立即检测',
      history: '历史',
      lastRun: '最近一次生图检测',
      ...
      runSuccess: '图片检测已启动',
      runFailed: '图片检测失败',
      createSuccess: '图片监控创建成功',
      updateSuccess: '图片监控更新成功',
      deleteSuccess: '图片监控删除成功',
      loadError: '加载图片监控失败',
      accountLoadError: '加载 OpenAI API Key 账号失败',
      proxyLoadError: '加载代理失败',
      saveError: '保存图片监控失败',
      ...
      form: {
        ...
        endpoint: '上游地址',
        apiKey: 'API Key',
        apiKeyEditPlaceholder: '留空表示不修改当前 Key',
        account: 'OpenAI API Key 账号',
        selectAccount: '选择账号',
        proxy: '代理',
        noProxy: '不使用代理',
        model: '图片模型',
      ...
      manual: {
        ...
        selectPreset: '选择预置',
        presetName: '预置名称',
        presetNamePlaceholder: '例如：4K 横图测试',
        savePreset: '保存当前设置',
        updatePreset: '更新预置',
        deletePreset: '删除预置',
        presetSaved: '手动检测预置已保存',
        presetDeleted: '手动检测预置已删除',
        presetNameRequired: '请输入预置名称',
        presetSaveFailed: '保存手动检测预置失败',
        start: '开始检测',
        cancel: '中止',
        cancelAll: '中止全部',
        canceled: '已中止',
        cancelFailed: '中止手动检测失败',
        elapsed: '耗时',
        history: '手动检测历史',
        viewHistory: '查看历史 ({count})',
        clearHistory: '清空历史',
        noHistory: '暂无手动检测历史',
        records: '手动检测记录',
        recordsSummary: '显示 {shown} / {total} 条记录',
        recordSearchPlaceholder: '搜索渠道、模型、提示词、IP 或 URL...',
        allStatuses: '全部状态',
        allModes: '全部模式',
        allChannels: '全部渠道',
        sortNewest: '最新优先',
        ...
        runLimitExceeded: '本轮将启动 {total} 条检测，超过上限 {max} 条',
        config: '参数配置',
        concurrency: '并发数',
        concurrencySummary: '并发×{count}',
        batch: '并发批次',
        batchIndex: '批次序号',
        batchAverage: '平均耗时',
        batchAverageShort: '均值',
        collapse: '收起',
        expand: '展开',
        selectAll: '全选',
        clearSelection: '清空',
        ...
        noTargets: '暂无可选渠道',
        startWithCount: '开始检测 ({count})',
        testingProgress: '检测中 {done}/{total}',
        ctaHint: '每个选中渠道并发 {concurrency} 条 · 结果实时进入右侧记录',
        batchRunning: '正在检测 {total} 条记录 · 完成 {done}/{total}',
        batchComplete: '本轮检测完成 {done}/{total}',
        resultOk: '成功',
        resultFail: '失败',
        waterfall: '耗时分解',
      ...
      runtime: {
        ...
        idle: '空闲',
        disabled: '已禁用',
        nextCheckIn: '{seconds} 秒后检测',
        nextCheckUnknown: '等待下次检测'
      },
      stages: {
        idle: '空闲',
        queued: '已排队',
    ...
    channelLoadtest: {
      title: '并发压测',
      description: '用流量档位对 OpenAI 兼容上游做高并发压测；画像会灌入预制档位，结束后可导出 Excel 报告',
      source: '测试目标',
      sourceAccount: '选择账号',
      sourceManual: '手填 API',
      account: '账号',
      accountPlaceholder: '搜索 OpenAI 兼容 API Key 账号…',
      noAccounts: '没有匹配的账号',
      baseUrl: 'Base URL',
      apiKey: 'API Key',
      apiKeyHint: '不会写入数据库或日志',
      proxy: '网络代理',
      noProxy: '不使用代理（直连）',
      proxyHint: '可选。选账号时默认带上该账号绑定的代理，可改成直连或其他代理',
      model: '模型',
      modelHint: '多个模型用逗号分隔，将按请求轮询',
      profile: '流量画像',
      profileHint: '选画像会立刻用预制组合替换下方档位表，可再改。真正开跑以档位表为准。',
      profileUser363: 'user363 混合（短同步 + 长大流）',
      profileStream: 'user363 长大流',
      ...
      sheetPresetHint: '选 SLA 画像或点此按钮：填入 50×50K、38×80K、10×160K、2×380K，并设并发 50。输出上限用当前 max_tokens。',
      tiers: '流量档位',
      tierInput: '输入 tokens',
      tierCount: '条数',
      addTier: '添加档位',
      removeTier: '删除',
      resetTiers: '恢复当前画像档位',
      tierHint: '本次按档位表发送 {n} 条。请求总数 = 各档条数之和；输出上限用当前 max_tokens。',
      tierInvalid: '每一档都要填写 1–400000 的整数输入 token，以及至少 1 条。最多 64 档，条数合计不超过 500。',
      tiersRequired: '请至少配置一档流量后再开始压测',
      appliedTiers: '本次档位',
      inputTokens: '构造输入',
      inputBand: '输入分档',
      dataProfileHint: '构造体量应对齐客户表；usage 是上游回传的真实 tokenizer。',
      sheetInput: '客户目标 输入',
      builtInput: '压测构造 输入',
      usageInput: '上游 usage 输入',
      sheetOutput: '客户目标 输出',
      usageOutput: '上游 usage 输出',
      apiMode: '端点',
      apiModeCC: 'Chat Completions（/v1/chat/completions）',
      apiModeRE: 'Responses（/v1/responses）',
      apiModeAutoHint: '默认选 Responses；仅当填入的模型全都是已知只支持 Chat Completions 的型号（当前：kimi*）时自动切到 CC。改模型会重新建议，仍可手改。',
      apiModeKimiHint: '当前模型只接受原生 /v1/chat/completions。即使选 Responses，引擎也会按模型改成 Chat Completions 再发出。',
      streamMode: '流式',
      streamModeAuto: '跟随画像',
      streamModeStream: '全部流式',
      streamModeSync: '全部同步',
      streamModeHint: '「跟随画像」按 user363 的同步/流式比例；选全部流式或同步会覆盖画像',
      concurrency: '并发',
      maxTokens: 'max_tokens（输出上限）',
      runKnobsHint: '请求总数由上方流量档位合计决定；并发控制同时在飞请求数。',
      tools: 'Tools',
      toolsAuto: '自动（流式带 tools）',
      toolsOff: '关闭',
      toolsCoding: 'coding tools',
      confirmCost: '确认大额 token 消耗',
      start: '开始压测',
      stop: '停止',
      exportExcel: '导出 Excel',
      exportError: '导出报告失败',
      exportModalTitle: '导出报告',
      exportModalHint: '默认全选。取消勾选的 sheet / 测试条件字段不会写入表格。文件名：开始时间_模型.xlsx',
      exportSheets: '工作表',
      exportSheetConditions: '测试条件',
      exportSheetOverview: '总览',
      exportSheetTtft: '首字延迟(ms)',
      exportSheetDuration: '总耗时(ms)',
      exportSheetSuccess: '成功率(%)',
      exportConditionFields: '测试条件字段',
      exportSelectAll: '全选',
      exportUnselectAll: '全不选',
      exportConfirm: '导出',
      ...
      success: '成功',
      rpmHint: '最近 60 秒内成功的请求数。峰值是全程最密的 60 秒，均是成功数除以压测时长。失败不计入。',
      rpmDetail: '峰值 {peak} · 均 {avg}',
      slaTitle: '二、性能指标（Performance）',
      dataTitle: '一、请求数据分布',
      contractTitle: '协议字段 / 空 model',
      failures: '失败请求',
      noResults: '还没有结果',
      startError: '启动压测失败',
      loadError: '加载压测状态失败',
      stopError: '停止压测失败',
      alreadyRunning: '已有压测在跑',
      pass: '通过',
      fail: '未通过',
      live: '实时',
      results: '请求明细',
      requestedModel: '请求模型',
      ttft: 'TTFT',
      ttftHint: '从发出请求到第一个输出 token。思考内容 reasoning_content 也算首字，所以会比“答案正文开始”更早。这段时间含网络。',
      ttftAnswer: '答案正文开始于 {n}',
      duration: '耗时',
      tpot: 'TPOT',
      timeUnitMs: '毫秒',
      timeUnitS: '秒',
      ...
      error: '报错',
      failOnly: '只看失败',
      emptyModelWarn: '{n} 个请求出现缺失/空 model（Go 客户端会报 got ""）'
    },
    ...
    channelMonitor: {
      ...
      form: {
        ...
        apiModeResponsesHint: '使用 /v1/responses，携带 instructions + input，适合自检/Codex 路径。',
        endpoint: '上游地址',
    ...
    subscriptions: {
      ...
      saveUserRate: '保存倍率',
      userRateSaved: '用户倍率已更新',
      failedToSaveUserRate: '保存用户倍率失败',
      form: {
        user: '用户',
        group: '订阅分组',
        validityDays: '有效期（天）',
      ...
      restore: '恢复',
      adjustQuota: '调整配额',
      adjustQuotaTitle: '调整用量配额',
      targetRemaining: '目标剩余额度',
      targetUsed: '目标已用额度',
      currentUsage: '当前已用',
      currentRemaining: '当前剩余',
      adjustQuotaHint: '调整的是当前订阅的已用额度；目标剩余额度会按分组周期上限自动换算为已用额度。若需提高周期上限，请到分组管理修改限额。',
      saveQuotaAdjustment: '保存调整',
      adjustingQuota: '保存中...',
      quotaAdjustedSuccess: '配额调整成功',
      failedToAdjustQuota: '调整配额失败',
      invalidQuotaAmount: '额度必须是大于或等于 0 的数字',
      quotaUsageExceedsLimit: '目标已用额度不能超过该周期上限',
      noQuotaAdjustment: '请至少填写一个周期的额度',
      resetQuota: '重置配额',
      ...
      guide: {
        ...
        actions: {
          ...
          adjustQuota: '调整配额',
          adjustQuotaDesc: '按日/周/月设置目标剩余或已用额度',
          resetQuota: '重置配额',
    ...
    accounts: {
      ...
      refreshInterval30s: '30 秒',
      autoRefreshCountdown: '自动刷新：{seconds}s',
      columnLayoutHint: '勾选显示列；用上下箭头调整顺序。表头右侧可拖动调整列宽。',
      resetColumnLayout: '重置列顺序与列宽',
      moveColumnUp: '上移',
      moveColumnDown: '下移',
      clearStuckRuntime: '清理卡住会话/并发',
      clearStuckRuntimeSuccess: '已清理：sticky {sticky} 条，并清空并发槽',
      clearStuckRuntimeFailed: '清理卡住会话失败',
      ...
      dataExportFormatSub2API: 'Sub2API 数据包',
      dataExportFormatSub2APIDesc: '导出账号、代理与运行配置，供本系统批量导入。',
      dataExportFormatCodex: 'Codex auth.json',
      dataExportFormatCodexDesc: '仅导出可用的 OpenAI OAuth 账号为 Codex ChatGPT 认证格式。',
      dataExportIncludeProxies: '导出代理（导出账号关联的代理）',
      dataExportOnlyUnexported: '只导出未导出过的账号',
      dataExportMarkExported: '导出成功后标记账号为已导出',
      dataExportLimit: '导出数量',
      dataExportLimitPlaceholder: '留空表示全部',
      dataExportLimitInvalid: '导出数量必须是大于 0 的整数',
      dataExportSelectedHint: '当前已选中 {count} 个账号；导出会优先使用选中账号，再按数量限制截断。',
      deleteExported: '删除已导出账号',
      deleteExportedDeleting: '删除中...',
      deleteExportedConfirm: '将删除当前筛选条件下已导出的 {count} 个账号，此操作不可恢复。确认继续？',
      deleteExportedNone: '当前筛选条件下没有已导出的账号',
      deleteExportedSuccess: '已删除 {count} 个已导出账号',
      deleteExportedPartial: '已导出账号删除部分完成：{success} 成功，{failed} 失败',
      deleteExportedFailed: '删除已导出账号失败',
      dataImport: '导入',
      codexSessionImport: {
        action: '导入 Codex 会话',
        title: '导入 Codex 会话账号',
        ...
        rateMultiplier: '计费倍率',
        loadFactor: '负载因子',
        updateExisting: '匹配到同一完整会话时更新已有账号',
        skipDefaultGroup: '未选分组时跳过默认分组绑定',
        submit: '导入会话',
        importing: '正在导入...',
        empty: '请输入 Codex 会话内容',
        failed: 'Codex 会话导入失败',
        summary: '共 {total} 条：新增 {created}，更新 {updated}，跳过 {skipped}，失败 {failed}'
      },
      dataExportConfirmMessage: '导出的数据包含账号与代理的敏感信息，请妥善保存。',
      dataExportConfirm: '确认导出',
      dataExported: '数据导出成功',
      dataExportFailed: '数据导出失败',
      exportCodexAuth: '导出 Codex',
      exportCodexAuthSuccess: 'Codex 认证文件导出成功',
      exportCodexAuthFailed: 'Codex 认证文件导出失败',
      exportCodexAuthUnavailable: '该账号缺少 Codex 所需的 OAuth token，无法导出。',
      ...
      accountSchedule: {
        master: '账号总闸',
        masterHint: '关闭后任何用户都不会选到这个账号。与账号列表上的「参与调度」是同一开关。',
        publicPool: '公共池',
        publicPoolHint: '关闭后，没有开启智能调度的用户选不到这个账号。智能池里的用户不受影响。',
        smartPool: '智能池成员',
        smartPoolHint: '列出当前平台所有已有智能池的用户。点入池/出池格子切换成员，点池内状态格子弹出六态。加入不会自动打开该用户×平台的智能调度。改动立即保存，不跟弹窗保存走。',
        poolStatus: '池启用',
        membership: '入池/出池',
        admission: '池内状态',
        inPool: '入池',
        outPool: '出池',
        searchUsers: '搜索用户邮箱或 ID',
        addUser: '加入用户',
        addSelected: '入池选中',
        remove: '移出',
        removeSelected: '出池选中',
        ...
        addSuccess: '已加入智能池',
        addFailed: '加入智能池失败',
        removeSuccess: '已移出智能池',
        removeFailed: '移出智能池失败',
        lastMemberDisabled: '已移出最后一名成员，该用户×平台智能调度已关闭',
        publicOn: '已加入公共池',
        publicOff: '已退出公共池',
        loadFailed: '加载智能池成员失败'
      },
      deleteAccount: '删除账号',
      ...
      userSchedule: {
        ...
        modeAllow: '允许名单',
        modeDeny: '拒绝名单',
        hint: '允许名单、拒绝名单、用户并发上限和质量门槛是四套独立配置，可重叠。拒绝优先于允许；质量门槛只挡该配对，不整号暂停。',
        allowHint: '非空时只有名单内用户可调度到该账号。',
        denyHint: '命中即不可调度，忽略该用户的并发上限。',
        concurrencyHint: '限制该用户在此账号上同时占用的路数。空或 0 表示不额外限制，最小为 1。',
        userConcurrency: '用户并发上限',
        concurrencyPlaceholder: '不限制',
        concurrencyEmpty: '先在允许/拒绝名单中加入用户，或在下方搜索添加。',
        capOnly: '仅设并发上限',
        capOnlyHint: '也可以搜索添加不在允许/拒绝名单中的用户，只限制他在此账号上的并发。',
        qualityGate: '质量门槛',
        qualityGateHint: '账号当前 last-N 首字/成功率不满足时，只停止把这个账号调度给该用户。未填的指标不判；未满 N 不判。',
        qualityTemplateHint: '模板全站只有一份，不绑定某个用户。保存模板会覆盖旧模板；应用模板只填入当前用户的门槛表单，需再保存账号才会生效。',
        qualityNoPauseHint: '用户门槛没有暂停时间：窗口不达标就停调给该用户。点「立即恢复」先变成已恢复；再点已恢复，或已恢复期满，会回到质量并开始重新累计 last-N 窗口。门槛不会被清掉。',
        qualityResume: '立即恢复',
        qualityResumeSuccess: '已立即恢复该用户调度',
        qualityResumeFailed: '恢复该用户调度失败',
        qualityWindowStartSuccess: '已开始重新累计 last-N 窗口',
        qualityGateChip: '质量',
        qualityBlockedChip: '已停',
        qualityBlockedChipTitle: '当前 last-N 质量未达标，已停止把此账号调度给该用户',
        qualityResumedChip: '已恢复',
        qualityResumedChipTitle: '已放行该用户。再点一次开始重新累计 last-N 窗口；已恢复期满也会自动开始。',
        qualityGateEmpty: '先加入用户，再为需要保护的用户填写门槛。',
        qualityGateOnly: '仅设质量门槛',
        qualityGateOnlyHint: '也可以搜索添加不在允许/拒绝名单中的用户，只为他设置质量门槛。',
        qualityMaxP50: '最高 p50（ms）',
        qualityMinSuccess: '最低成功率（%）',
        qualityMinSuccessSamples: '最小成功样本',
        qualityMinTtftSamples: '最小首字样本',
        qualityWindowN: '判定最少样本 N（共用账号窗）',
        qualityCondition: '判定条件',
        qualityConditionOr: '或（任一越界）',
        qualityConditionAnd: '与（全部越界）',
        qualitySave: '保存门槛',
        qualityClear: '清除门槛',
        usersRequired: '允许/拒绝模式至少选择一名用户',
        restoreDefault: '恢复默认',
        restoreDefaultHint: '清空允许名单、拒绝名单、对级并发和质量门槛',
        enableWrite: '写入用户调度',
        enableAllowWrite: '覆盖允许名单',
        enableDenyWrite: '覆盖拒绝名单',
        overwriteHint: '勾选后覆盖所选账号对应名单（不是合并）。批量不会改用户并发上限或质量门槛。',
        deleted: '已删除',
        userCountTotal: '共 {count} 名用户',
        pairCap: '用户并发上限'
      },
      ...
      viewErrorRequests: '查看错误请求记录',
      viewErrorRequestsShort: '错误',
      viewStability: '查看稳定性曲线与硬关闭',
      viewStabilityShort: '稳定性',
      ...
      quality: {
        ...
        failoverShort: '含',
        bridgeShort: '桥',
        windowCounts: '首字 {ttft}/{n} · 成功 {ok}/{n}',
        ttftHint:
          '最近 N 条真首字延迟（首次有用输出，不含 Responses preamble）。主指标 p50（中位数，抗异常值）；副指标 p95（尾延迟）。悬停可看均值/最大值与 k/N。无样本显示 —。',
        successRateHint:
          '最近 N 条调度成功率 = 成功次数 / (成功 + 非桥接失败)。成功来自 usage_logs，失败来自 ops 错误日志（含 429/529，排除 count_tokens、Claude→GPT 桥接失败，以及客户端/路由的模型不存在或不受支持）。上游 429/502/503 仍计入。无样本显示 —。',
        tooltip: '最近 {n} 条 · 成功 {success} · 失败 {error} · 首字 {ttftSamples}/{n}',
        failoverTooltip:
          '最近 {n} 条 · 含 failover/Recovered 对照正确率（1 − 对照错误率）· 对照失败 {error} · 不进调度',
        bridgeTooltip: '最近 {n} 条 · 桥接成功 {success} · 桥接失败 {error}（不进调度）',
        ttftTooltip:
          '最近 {n} 条 · 样本 {samples}/{n} · p50 {p50}ms · p95 {p95}ms · 均值 {avg}ms · 最大 {max}ms'
      },
      stability: {
        title: '账号稳定性 · {name}',
        chartTitle: '近 24 小时质量曲线',
        chartHint: '每个点都是当时的 last-N 窗口快照（相邻点会重叠），不是互斥时间桶。',
        noData: '暂无质量快照',
        ...
        resumeNow: '立即恢复调度',
        resumeHint: '不用等暂停时间结束。若当前 last-N 窗口仍越界，下次评估可能再次暂停。',
        resumeSuccess: '已清除质量暂停，账号重新进入调度',
        resumeFailed: '恢复调度失败',
        globalDisabledHint: '系统总开关当前关闭。仍可保存本账号配置，但不会开始评估，直到系统设置打开总开关。',
        formTitle: '账号硬关闭',
        templateHint: '模板全站只有一份。保存模板会覆盖旧模板；应用模板只填入当前表单，需再点保存才会写到本账号。',
        saveTemplate: '保存模板',
        applyTemplate: '应用模板',
        saveTemplateSuccess: '已覆盖保存为共享模板',
        saveTemplateFailed: '保存模板失败',
        applyTemplateSuccess: '已应用共享模板到当前表单',
        applyTemplateFailed: '应用模板失败',
        enabled: '启用本账号硬关闭',
        enabledHint: '需同时打开系统总开关后才会按阈值暂停调度',
        useGlobal: '使用系统默认模板',
        useGlobalHint: '关闭后可覆盖本账号的阈值、暂停时间和与/或条件。窗口 N 是全站的，不能按账号改。',
        maxP50: '最高 p50 首字（毫秒）',
        minSuccessRate: '最低成功率（%）',
        minSuccessRateHint: '界面按百分比填写，保存时转换为 0–1',
        pauseMinutes: '暂停分钟数',
        minSuccessSamples: '最小成功样本（成功+失败）',
        minTtftSamples: '最小首字样本',
        windowN: '账号质量窗口 N',
        windowNHint: '全站账号质量与硬关闭共用最近 N 条，此处只读。要改 N 请去系统设置。范围 1–100，默认 20。不是智能调度配对质量的 N。',
        condition: '判定条件',
        conditionInherit: '继承全局',
        conditionOr: '或：任一已判定指标越界即停',
        conditionAnd: '与：所有已判定指标同时越界才停',
        saveSuccess: '账号硬关闭配置已保存',
        saveFailed: '保存账号硬关闭配置失败',
        loadFailed: '加载稳定性数据失败',
        p50Series: 'p50（毫秒）',
        p95Series: 'p95（毫秒）',
        showP95: '显示 p95',
        p95ClippedHint: '部分 p95 超出当前刻度，已夹到顶部。隐藏 p95 可按 p50 放大左轴。',
        successRateSeries: '成功率（%）',
        samplesSummary: '最近一点：成功 {success}/{n} · 失败 {error} · 首字 {ttft}/{n}',
        bridgeTitle: 'Claude→GPT 桥接错误率',
        failoverTitle: '账号错误率对照',
        failoverTerminal: '不含 failover',
        failoverInclusive: '含 failover / Recovered',
        failoverSchedule: '当前调度口径',
        failoverToggle: '将含 failover 的错误率作为调度错误率',
        failoverToggleHint:
          '默认关：智能调度门槛和硬关闭继续用现有口径（客户端 status≥400，已排除模型不存在）。打开后，调度才把本号 Recovered 429/503 算进 ErrorCount。开关写入全站质量模板，不是只存在浏览器里。保存后列表数字立即更新；选号热路径最多等下一次 last-N 质量重算。',
        failoverSamples: '不含 {terminal} 次 · 含 {failover} 次',
        failoverEmpty: '该窗口没有可对照的账号错误样本。',
        bridgeHint: '当前 last-N live 窗口。只展示，不进智能调度门槛或硬关闭。',
        bridgeSamples: '桥接成功 {success} · 桥接失败 {error}',
        bridgeEmpty: '该窗口无桥接样本'
      },
      publicQuality: {
        title: '公共调度质量',
        hint: '只影响无池用户。样本是账号上的全部请求。门槛 / 考察期 / 调度期 / 冷却与智能调度池同一套 EvalQuality。默认关；打开后软降权，冷却号仍可出号。不设考察并发上限，也没有考察预检 v2。',
        column: '公共质量',
        columnHint:
        ...
        nShort: 'N',
        minSuccessRate: '最低成功率（%）',
        minSuccessRateShort: '成功率%',
        cooldownGroup: '冷却',
        cooldownMinutes: '冷却分钟',
        cooldownShort: '冷却分',
        softCooldown: '软冷却（冷却后新样本达标则直接恢复）',
        softCooldownShort: '软冷却',
        save: '保存全局配置',
        saveShort: '保存',
        saved: '公共调度质量已保存',
        saveFailed: '保存公共调度质量失败',
        loadFailed: '加载公共调度质量失败'
      },
      ...
      testConnection: '测试连接',
      moveToTop: '移到顶部',
      moveToTopSuccess: '已将该账号移到列表顶部',
      moveToTopFailed: '移到顶部失败',
      ...
      usageWindow: {
        ...
        balanceUnlimitedHint: '上游标记无限额度（仅展示，不参与调度）',
        balanceUnlimitedNoUsed: '无限·无已用数据',
        balanceUsedOnly: '已用 ${used}',
        editDisplayBalance: '编辑展示余额（仅展示）',
        editDisplayBalanceHint: '仅用于列表展示，不影响调度与扣费；自动刷新会覆盖「已用」',
        refreshBalance: '从上游刷新余额',
        usedLabel: '已用',
        totalLabel: '总额',
        remainingLabel: '剩余',
        totalOptional: '可选，如 125',
        invalidBalanceNumber: '请输入有效的非负数字',
        displayBalanceSaved: '展示余额已保存',
        displayBalanceSaveFailed: '保存展示余额失败',
        refreshBalanceFailed: '刷新上游余额失败',
        burnRateUsd: '~${rate}/时',
      ...
      openaiQuotaReset: {
        count: '次数',
        reset: '重置',
        resetTooltipShadow: 'Spark 影子账号不能重置母账号额度，请在母账号上操作',
        ...
        confirmTitle: '确认重置周限',
        confirmMessage: '将消耗 1 次重置次数且不可撤销，确定继续吗？（剩余 {count} 次）',
        expiresAt: '{time} 到期',
      ...
      bulkEdit: {
        ...
        selectionInfoFiltered: '将按当前筛选条件更新约 {count} 个账号。只更新您勾选或填写的字段，未勾选的字段保持不变。',
        layoutHint: '布局与「编辑账号」一致：账号配置、分组、其他功能、用户调度。勾选字段右侧复选框才会写入。',
      ...
      unbindSubscriptionByRate: {
        button: '高倍率仅留按量分组',
        title: '按计费倍率解除订阅分组',
        description: '计费倍率严格大于阈值的账号会去掉订阅（配额）分组，只保留标准（按量）分组。预览不写库；确认后会重新扫描当前数据再写入。',
        minRate: '计费倍率阈值',
        minRateHint: '只匹配计费倍率严格大于该值的账号。等于阈值的账号不会被选中。比较的是计费倍率，不是上游调度倍率。',
        platform: '平台',
        platformAll: '全部平台',
        allowEmpty: '允许改成无分组',
        allowEmptyHint: '去掉订阅分组后如果没有剩余分组，默认跳过。勾选后会写成无分组。',
        preview: '预览',
        previewing: '预览中...',
        apply: '确认解除（{count}）',
        applying: '处理中...',
        confirmApply: '将按当前规则重新扫描并写入 {count} 个账号，不会使用上次预览的过期 ID 列表。',
        stalePreview: '条件已更改，请重新预览。',
        emptyPreview: '没有可写入的账号。',
        counts: {
          matched: '匹配 {count}',
          wouldApply: '将写入 {count}',
          skippedNoSubscription: '无订阅分组 {count}',
          skippedEmpty: '将变成空分组 {count}',
          applied: '已写入 {count}',
          failed: '失败 {count}'
        },
        table: {
        ...
        action: {
          preview: '将写入',
          skip_no_subscription: '跳过：无订阅分组',
          skip_empty: '跳过：将变成空分组',
          applied: '已写入',
          failed: '失败'
        },
        previewFailed: '预览失败',
        applyFailed: '解除失败',
        applySuccess: '已处理：成功 {applied}，失败 {failed}'
      },
      ...
      sparkShadowBulkSkipped: '已跳过 {count} 个 Spark 影子账号',
      resetStatus: '重置状态',
      statusReset: '账号状态已重置',
      ...
      openai: {
        ...
        chatCompletionsProbeSupported: '自动探测结果：支持 /v1/chat/completions',
        chatCompletionsProbeUnsupported: '自动探测结果：不支持 /v1/chat/completions',
        chatCompletionsProbeUnknown: '自动探测结果：尚未探测 /v1/chat/completions',
      ...
      anthropic: {
        ...
        apiKeyAuthSchemeDesc:
          '选择 Anthropic-compatible 上游使用的 API Key 认证头。Ollama Cloud 使用 Authorization: Bearer。',
      ...
      mapRequestModels: '将请求模型映射到实际模型。左边是请求的模型，右边是发送到 API 的实际模型。添加映射会保留白名单恒等键；同一请求名以新映射为准。',
      ...
      poolModeHardEviction: '硬错误停调度',
      poolModeHardEvictionHint: '仅在池模式下生效，默认关闭。关闭后回到旧池模式。',
      poolModeHardEvictionInfo:
        '开启后，余额不足、额度用尽、上游 Key 过期/用户停用/订阅无效等必须人工处理的错误会停止调度并显示原因。',
      ...
      upstreamRateMultiplier: '上游倍率',
      upstreamRateMultiplierHint: '只影响选号，不影响计费。越低越优先。OAuth/API Key 默认 0.15，其他类型默认 1',
      expiresAt: '过期时间',
      ...
      customTestModel: '自定义测试模型',
      customTestModelPlaceholder: '例如 claude-haiku-4-5',
      customTestModelHint: '填写后优先使用此名称请求，可测列表外的短名或映射目标。',
      testSelectedModel: '选择模型：{model}',
      testMappedModel: '映射后：{model}',
      testMappingSource: '映射来源：{source}',
      mappingSourceAccount: '账号映射',
      mappingSourcePlatformDefault: '平台默认映射',
      mappingSourcePrefix: 'OAuth 前缀规范化',
      mappingSourceVertex: 'Vertex 规范化',
      mappingSourceNone: '未命中（透传）',
      testModelListHintClaudeApiKeyMapped:
        '列表来自账号映射键 ∪ 平台默认映射键，不是价目表。有账号映射的 Claude API Key 不含 DefaultModels。平台映射的目标名不在列表中，请用自定义输入。',
      testModelListHintClaudeDefault: '列表来自 DefaultModels ∪ 平台默认映射键，不是价目表。',
      testModelListHintOpenAI: '列表来自账号映射键 ∪ 平台默认映射键 ∪ DefaultModels，不是价目表。',
      testModelListHintOpenAIPassthrough: '透传账号列表仅为 DefaultModels，不是价目表。',
      testModelListHintGeminiMapped: '列表来自账号映射键 ∪ 平台默认映射键，不是价目表。',
      testModelListHintAntigravity: '列表来自生效映射表的请求模型名，不是价目表。',
      testModelListHintGeneric: '列表来自账号/平台映射或默认模型集，不是价目表。列表外名称可用自定义输入测试。',
      testEndpoint: '测试端点',
      testEndpointAuto: '跟随账号路由',
      testEndpointResponses: 'Responses（RE /v1/responses）',
      testEndpointChatCompletions: 'Chat Completions（CC /v1/chat/completions）',
      testEndpointHint: '只影响这一次测试，不会修改账号保存的上游路由。跟随账号时按当前路由走 Responses 或 Chat Completions。',
      testEndpointUsed: '测试端点：{endpoint}',
      testModel: '测试模型',
      testPrompt: '提示词："hi"',
    ...
    redeem: {
      ...
      detail: '详情',
      copyUnused: '复制未使用',
      deleteUnusedInBatch: '删除未使用',
      deleteUnusedInBatchConfirm: '确定删除该批次中全部未使用的兑换码吗？已使用的码不会删除。',
      batchDetailTitle: '批次详情',
      batchDetailSummary: '共 {total} 个 · 未使用 {unused} · 已使用 {used}',
      batchEmpty: '该批次暂无兑换码',
      totalShort: '共 {n}',
      unusedShort: '未用 {n}',
      usedShort: '已用 {n}',
      expiredShort: '过期 {n}',
      generatedPanelTitle: '本次生成结果',
      generatedPanelEmpty: '在左侧配置后点击生成，结果将显示在此处；再次生成会覆盖显示。',
      copiedUnused: '已复制 {count} 个未使用兑换码',
      types: {
        balance: '余额',
        concurrency: '并发数',
        subscription: '订阅',
    ...
    usage: {
      ...
      userFilter: '用户',
      searchUserPlaceholder: '按邮箱搜索用户，或点击查看最近访问',
      searchApiKeyPlaceholder: '按名称搜索 API 密钥...',
      searchAccountPlaceholder: '按名称搜索账号，或点击查看最近访问',
      recentPicks: '最近访问',
      browseUsers: '最近活跃用户',
      browseAccounts: '最近使用账户',
      searchResults: '搜索结果',
      noRecentUsers: '暂无最近用户，可输入邮箱搜索',
      noRecentAccounts: '暂无最近账户，可输入名称搜索',
      selectedUser: '已选择',
      user: '用户',
      account: '账户',
      group: '分组',
    ...
    ops: {
      ...
      scheduleErrorWhitelist: {
        ...
        customTitle: '自定义规则',
        customHint: '人工新增只填消息包含。从错误日志加入的是结构化指纹，只能停用或删除。',
        customEmpty: '还没有自定义规则。',
        customAdd: '添加',
        customAddPlaceholder: '消息包含（字面量子串）',
        customSaved: '自定义规则已保存',
        customMessageLabel: '消息包含',
        customStructuredLabel: '结构化规则',
        addFromLog: '加入白名单',
        addFromLogTitle: '加入调度错误白名单',
        addFromLogHint: '默认按这条日志的 type / phase / status / provider code 生成结构化规则。也可改存为消息包含。',
        addStructured: '加入结构化规则',
        addMessage: '只按消息包含',
        added: '已加入调度错误白名单',
        addFailed: '加入白名单失败',
        hardCountedBlocked: '502 Upstream request failed 不能加入白名单，始终计入调度。',
        families: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        slimCompleted: '精简 Responses completed 事件',
        slimCompletedHint: '兼容 NewAPI 把空 output[] 或过胖 response.completed 当成无输出。开启后下游只收到 type / response.id / usage 整数。默认关闭；打开全站开关后对所有人生效。',
        slimCompletedUserIds: '仅这些用户开启',
        slimCompletedUserIdsHint: '全站开关关闭时，只有名单内用户会精简 completed；打开全站后所有人生效。灰度时把用户加进名单即可，不必打开全站开关。',
      ...
      qualityHardClose: {
        title: '质量硬关闭',
        description: '系统总开关与唯一共享模板。账号硬关闭和用户调度质量门槛都可保存/应用该模板（新的覆盖旧的，不绑定用户）。保存此卡片不会启用任何账号。',
        enabled: '启用质量硬关闭总开关',
        enabledHint: '关闭时即使账号已开启也不会评估。打开后只评估同时开启的账号。',
        scheduleUseFailover: '将含 failover 的错误率作为调度错误率',
        scheduleUseFailoverHint:
          '默认关。打开后智能调度门槛 / live ErrorCount 才计入 Recovered 上游失败。对照数字仍始终计算。',
        templateHint: '这是全站唯一模板。账号硬关闭和用户调度质量门槛的“保存模板”都会覆盖这里；“应用模板”把这里填进当前表单。保存此卡片不会启用任何账号，也不会绑定某个用户。',
        maxP50: '最高 p50 首字（毫秒）',
        minSuccessRate: '最低成功率（%）',
        minSuccessRateHint: '界面按百分比填写，保存时转换为 0–1。留空表示不配置该指标。',
        pauseMinutes: '暂停分钟数（1–1440）',
        minSuccessSamples: '最小成功样本（成功+失败）',
        minTtftSamples: '最小首字样本',
        windowN: '账号质量窗口 N',
        windowNHint: '账号列表与硬关闭共用最近 N 条。范围 1–100，默认 20。不是智能调度配对质量的 N。',
        condition: '判定条件',
        conditionOr: '或：任一已判定指标越界即停',
        conditionAnd: '与：所有已判定指标同时越界才停',
        saved: '质量硬关闭设置保存成功',
  ...
  payment: {
    ...
    errors: {
      ...
      EASYPAY_CONFIG_INVALID_URL: '易支付接口地址必须是完整的 http(s) 地址',
...
const v117ZhPatch = {
  ...
  distribution: {
    ...
    features: {
      recharge: {
        title: '余额兑换码',
        description: '按兑换比例扣除分销余额生成余额兑换码。',
      },
      codes: {
        title: '订阅兑换码',
        description: '按后台折扣比例扣除分销余额生成订阅兑换码。',
      },
      api: {
        title: 'API Key 分销',
        description: '按定额生成 API Key，并可设置有效期。',
      },
    },
    generate: {
      balanceTitle: '余额兑换码',
      subscriptionTitle: '订阅兑换码',
      apiTitle: 'API Key',
      valueUsd: '面值（USD）',
      faceValueRmb: '面值（RMB）',
      quotaUsd: '额度（USD）',
      ...
      failed: '生成失败',
      success: '生成成功',
      balanceHint: '预计扣款：{cost}',
      subscriptionHint: '套餐价格：{price}；代理折扣：{discount}；成本：{cost}',
      apiHint: '预计扣款：{cost}',
    ...
    assets: {
      ...
      voidFailed: '停用资产失败',
      recharge: '充值',
      rechargeTitle: '充值 API Key',
      rechargeHint: '预计扣款：{cost}',
      rechargeSuccess: 'API Key 已充值，扣款 {amount}。',
      rechargeFailed: '充值 API Key 失败',
      disable: '停用',
      disableSuccess: '资产已停用',
      disableFailed: '停用资产失败',
      enable: '启用',
      enableSuccess: '资产已启用',
      enableFailed: '启用资产失败',
      refund: '退款',
      refundConfirm: '确认退款这个 API Key？预计退款 {amount}，退款后该 Key 将彻底失效。',
      refundSuccess: 'API Key 已退款，退回 {amount}。',
      refundFailed: '退款 API Key 失败',
      columns: {
        type: '类型',
        name: '名称',
        value: '兑换码 / Key',
      ...
      types: {
        ...
        subscription_redeem_code: '订阅兑换码',
        api_key: 'API Key',
      },
      status: {
        active: '可用',
    ...
    ledger: {
      ...
      actions: {
        admin_adjust: '管理员调账',
        generate_redeem_code: '生成余额码',
        generate_subscription: '生成订阅码',
        generate_api_key: '生成 API Key',
        recharge_api_key: '充值 API Key',
        asset_refund: '资产退款',
      },
    },
  },
  ...
  usage: {
    ...
    antigravity: {
      ...
      creditsPerCall: '每请求点数',
      tokensPerCredit: '每点数 Token',
      curveTitle: 'Antigravity 点数消耗曲线',
      curveSubtitle: '按时间窗口对比 AI 点数、请求数、Token 和额度消耗',
      anomalyHint: '{time} 峰值：单请求点数为常态 {score} 倍',
  ...
  admin: {
    distribution: {
      ...
      searchPlaceholder: '搜索邮箱或用户名...',
      loadFailed: '加载申请列表失败',
      loadWalletsFailed: '加载钱包列表失败',
      loadLedgerFailed: '加载钱包流水失败',
      loadAssetsFailed: '加载生成资产失败',
      saveSettingsFailed: '保存分销设置失败',
      adjustFailed: '调整钱包余额失败',
      statusFailed: '更新钱包状态失败',
      reviewSuccess: '审核已保存',
      reviewFailed: '保存审核失败',
      quickStats: '概览',
      agentAccounts: '代理账户',
      ...
      adjustAmount: '调整金额',
      rates: '代理专属比例',
      ratesHint: '填 0 表示使用全局设置。',
      ratesFailed: '保存代理专属比例失败',
      freeze: '冻结',
      unfreeze: '解冻',
      approveTitle: '通过分销申请',
      rejectTitle: '拒绝分销申请',
    ...
    modelPricing: {
      ...
      displayCacheCreationPriceHint: '缓存创建按此展示价直接反算 token 数（真实成本 ÷ 展示价），不影响实际计费。设为真实缓存写入价的等比缩小值可让展示 token 等比放大。未配 1h 档展示价时，本价同时作用于 5m/1h 两档。',
      displayCacheCreation1hPrice: '展示 1h 缓存创建价（$/百万 Token）',
      displayCacheCreation1hPriceHint: '1h 档缓存创建的展示单价。留空 = 与展示缓存创建价同价。配置后按档分别反算展示 token；建议同时配置真实 5m/1h 计费价以保证成本拆分精确。',
      ...
      imageBillingStrategy: '图片计费',
      imageBillingMegapixel: '按百万像素',
      imageBillingTier: '按档位',
      imageFallbackPrice: '兜底价格',
      imageFallbackPlaceholder: 'auto / 未知尺寸',
      imageMegapixelDefault: '默认',
      imageQualityDefault: '默认',
      imageQualityPricesTitle: '质量单价覆盖',
      imageQualityPricesHint: '可选。留空时使用默认百万像素单价；填写后对应 quality 会按该单价计费。',
      imageQualityMultipliersTitle: '质量价格乘数',
      imageQualityMultipliersHint: '作用于命中的档位价格。OpenAI 不传 quality 时默认为 auto，因此 auto 乘数默认设为 1。',
      imageQualityMultiplierDefault: '默认 1',
      imageTierLabel: '{tier} 档位',
      imageTierPricePlaceholder: '{tier} 价格',
      imageTierMaxPixelsPlaceholder: '最大像素数，留空为无限制',
      ...
      inlineEditHint: '提示：点击表格中的价格可快速编辑；默认映射命中后的计费对象可在表格中直接修改。',
      inlineEditTitle: '快速编辑',
      openFullDialog: '更多字段...',
      baselinePrefix: '基准',
      saveInline: '保存',
      billingBasisTitle: '计费对象规则',
      billingBasisIntro: '平台默认映射命中后，价格查找可以选择使用哪个模型名：',
      billingBasisRequested: '按请求模型：使用客户端原始请求的模型名，未配置时保持此默认行为。',
      billingBasisChannelMapped: '按映射后模型：使用平台默认映射后的模型名查找价格。',
      billingBasisNoChannel: '这个设置只作用于平台默认映射；账号级映射和渠道级计费设置仍按各自配置生效。',
      billingBasisColumnNote: '“计费对象”列可直接修改请求模型行；映射后模型行可能对应多个请求名，因此只读展示。',
      billingObjectRequested: '按请求模型',
      billingObjectMapped: '按映射后模型',
      billingObjectSaved: '计费对象已保存',
      mappingNotEditable: '该行不是自定义默认映射，不能删除或编辑映射。',
      requestedModelName: '请求模型',
      upstreamModelName: '映射后模型',
      billingMode: '计费对象',
      billingModeByRequested: '请求模型',
      billingModeByUpstream: '映射后模型',
      ...
      hiddenModels: '已隐藏',
      hideModelTitle: '从列表删除（可在“已隐藏”恢复）',
      confirmHideModel: '确定从模型配置列表删除“{model}”吗？删除后不再显示（不影响计费与请求转发），可在来源筛选的“已隐藏”里恢复。',
      modelHidden: '已从列表删除，可在“已隐藏”里恢复',
      restoreModel: '恢复',
      modelRestored: '已恢复显示',
      addMapping: '添加映射',
      editMapping: '编辑映射',
      deleteMapping: '删除映射',
      confirmDeleteMapping: '确定删除映射“{from}”吗？这会从当前提供商的默认映射表中移除该条目。',
      ...
      testAccount: '测试账号',
      testNoAccount: '没有可用的 {provider} 账号',
      testPrompt: '测试提示词',
      testPromptPlaceholder: '输入测试提示词...',
      sendTest: '发送测试',
      testing: '测试中...',
    ...
    users: {
      ...
      applySuggestedToCurated: '一键应用精选模型建议值',
      applySuggestedToCuratedHint: '将该平台默认精选模型的计费价和展示价都填为 LiteLLM 建议值，需点保存后生效。',
      otherPlatform: '其他',
      noModelOverridesOnPlatform: '该平台暂无模型覆盖',
      ...
      displayCacheWritePrice: '展示缓存写入价',
      displayCacheWrite1hPrice: '展示 1h 缓存写入价',
      displayCacheReadPrice: '展示缓存读取价',
      displayRate: '展示倍率',
  ...
  legalConsent: {
    registerTitle: '使用条款与免责声明确认',
    loginTitle: '使用条款与免责声明已更新',
    ...
    regionTitle: '内部科研用途',
    regionBody: '本系统仅限内部授权人员用于大模型接口兼容性测试、上游模型能力验证、API 网关与鉴权限流调度测试、请求日志分析、错误排查、稳定性验证、内部系统联调、数据验证和技术研究。本平台不向公众提供生成式人工智能服务，不作为任何商业产品、代理服务、转售服务、充值服务或对外 API 服务使用。若您位于中国大陆地区，或适用法律法规、监管要求、上游服务政策禁止您访问或使用本平台，请立即停止访问并不要注册、登录或使用。',
    prohibitedTitle: '严禁行为',
    prohibited: {
      nsfw: '生成、传播淫秽色情、露骨性内容或其他 NSFW 内容。',
      violence: '生成暴力、恐怖、血腥、极端主义或煽动伤害的内容。',
      minors: '生成、请求、传播任何涉及未成年人的不当、性化或剥削性内容。',
      sillyTavern: '将本平台 API 接入 SillyTavern、角色扮演工具、公开聊天站、商业 Bot 或其他第三方系统用于违规内容生成。',
      privacy: '侵犯他人隐私、名誉、肖像、个人信息、商业秘密或知识产权。',
      fraud: '从事诈骗、赌博、洗钱、钓鱼、虚假宣传、垃圾信息或其他违法犯罪活动。',
      security: '批量注册、批量调用、恶意请求、压力攻击、数据抓取、接口扫描、逆向分析、绕过限流风控、生成恶意代码、凭证窃取、漏洞利用或危害网络安全的行为。',
      commercial: '公开运营、商业销售、接口转售、代充、分销、套利、接入外部客户系统或任何对外经营活动。',
      disclosure: '传播平台地址、账号权限、API Key、调用方式、价格信息、接口配置、上游信息或其他内部资料。',
      illegal: '危害国家安全、公共安全、公共秩序，或从事任何违反适用法律法规和上游服务政策的行为。'
    },
    enforcementTitle: '违规处理',
    enforcementBody: '平台可根据自动检测、人工审核、日志分析、用户举报、上游反馈或监管要求，对异常或违规行为采取警告、限制调用、降低额度、暂停权限、冻结或关闭账号及 API Key、删除或保留相关日志和调用证据、取消测试资格、回收访问权限、向相关负责人、上游服务商、监管机构或有关部门报告并配合调查等措施。因用户违规使用造成的损失、处罚、索赔或法律后果，由用户自行承担。',
    accountTitle: '账户与 API Key 安全',
    accountBody: '平台账号仅限经授权的内部人员本人使用。用户不得转借、共享、出租、出售、转售、代充、分发账号、密码、API Key、令牌、访问地址或任何平台信息，也不得协助第三方使用本平台。因泄露、转借、共享或保管不当造成的风险、损失、封禁或法律责任，由使用者自行承担。',
    availabilityTitle: 'AI 输出与可用性免责声明',
    availabilityBody: '本平台仅作为内部技术测试环境，不对上游 AI 模型输出内容的准确性、完整性、合法性、适用性、稳定性或安全性作任何保证。用户应自行判断输入、输出、调用场景和测试目的，并对使用本平台及模型输出产生的全部后果承担责任。平台不承诺持续可用、稳定可用或永久保留任何功能、额度、模型、账号、日志或数据；可因技术调整、风控需要、上游政策、合规要求或内部管理需要，随时限制、暂停、关闭或调整相关功能。',
    termsCheck: '我已完整阅读并同意本使用条款与免责声明，理解本平台仅限内部技术研究、接口测试、系统联调和数据验证使用。',
    authorizedUseCheck: '我确认本人为授权内部测试人员，知悉本平台非商业平台，不开放公众注册、充值、购买、代充、转售、分销或任何对外经营使用。',
    confirmationLabel: '确认语',
    confirmationHint: '请逐字输入：{phrase}',
    countdown: '请继续阅读 {seconds} 秒后再确认。',
    scrollRequired: '请滚动到条款最底部后再确认。',
    ready: '已满足阅读要求，可以确认。',
    acceptButton: '我已阅读并同意'
  }
}

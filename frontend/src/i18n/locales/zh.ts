  ...
  admin: {
    ...
    users: {
      ...
      smartSchedule: {
        ...
        add: '加入',
        addRegionTitle: '添加账号',
        addRegionHint: '快速搜索加入单个账号，或打开筛选弹窗按账号管理条件预览后批量加入。加入后需点保存。',
        filteredAdd: '筛选添加',
        ...
        addFilteredSuccess: '已加入 {count} 个账号，保存后生效',
        ...
        dirtyBanner: '有未保存的账号池 / 配对并发 / 门槛修改。自动刷新不会覆盖这些草稿，需点保存后才会生效。',
        dirtySaveHint: '成员与配对并发仍需保存',
        admission: '入池状态',

...
const v117ZhPatch = {
  ...
  legalConsent: {
    registerTitle: '服务条款与免责声明确认',
    loginTitle: '服务条款已更新',
    registerNotice: '注册前必须完整阅读并确认以下条款。未完成确认前不会创建账户。',
    loginNotice: '平台服务条款和免责声明已更新。继续使用前，请完整阅读并确认。',
    version: '条款版本：{version}',
    disclaimerTitle: '免责声明',
    disclaimerBody: '本平台仅提供 AI API 转发服务，不保证上游模型输出内容的准确性、完整性、合法性、适用性或稳定性。用户应自行判断输入、输出和使用场景，并对使用本平台及模型输出产生的后果负责。',
    regionTitle: '地区与适用法律限制',
    regionBody: '本网站服务不向中国大陆地区提供服务，也不面向位于中国大陆地区的个人、组织或设备开放注册、访问、购买或使用。若您位于中国大陆地区，或适用法律禁止您使用本服务，请立即停止访问并不要注册或使用。',
    prohibitedTitle: '严禁行为',
    prohibited: {
      nsfw: '生成、传播淫秽色情、露骨性内容或其他 NSFW 内容。',
      violence: '生成暴力、恐怖、血腥、极端主义或煽动伤害的内容。',
      minors: '生成、请求、传播任何涉及未成年人的不当、性化或剥削性内容。',
      sillyTavern: '将本平台 API 接入酒馆 AI（SillyTavern）等角色扮演工具用于生成违规内容。',
      privacy: '侵犯他人隐私、名誉、肖像、个人信息、商业秘密或知识产权。',
      fraud: '从事诈骗、赌博、洗钱、钓鱼、虚假宣传、垃圾信息或其他违法犯罪活动。',
      security: '生成恶意代码、攻击脚本、凭证窃取、漏洞利用、绕过安全机制或危害网络安全的内容。',
      illegal: '危害国家安全、公共安全、公共秩序，或从事任何违反适用法律法规和上游服务政策的行为。'
    },
    enforcementTitle: '违规处理',
    enforcementBody: '平台可根据自动检测、人工审核、用户举报、上游反馈或监管要求，对违规账户采取警告、限制调用、暂停服务、封禁账户、冻结或扣除余额、保存证据、向有关部门举报并配合调查等措施。因用户违规使用导致的一切法律后果由用户自行承担。',
    accountTitle: '账户与 API Key 安全',
    accountBody: '用户应妥善保管账户、密码、API Key 和调用凭证。因用户泄露、共享、转售、转借或未妥善保管导致的损失、滥用、封禁或法律责任，由用户自行承担。',
    availabilityTitle: '服务可用性与上游风险',
    availabilityBody: '本平台不保证服务持续、稳定、无错误或永久可用。模型、价格、额度、限流、上游账号、支付渠道、可用地区和功能可能因技术、运营、上游服务商政策或法律要求发生变化。',
    termsCheck: '我已完整阅读并同意服务条款、免责声明、可接受使用政策、隐私与支付/退款相关规则。',
    regionCheck: '我确认本人、组织、设备及付款来源不位于中国大陆地区，且适用法律未禁止我使用本服务。',

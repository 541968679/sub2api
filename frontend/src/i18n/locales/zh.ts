...
const v117ZhPatch = {
  ...
  admin: {
    ...
    modelPricing: {
      ...
      inlineEditHint: '提示：点击表格中的价格可快速编辑；计费基准请在上方渠道设置中修改。',
      ...
      billingBasisColumnNote: '“映射角色”列是由映射关系推导出的只读标签。实际计费基准由请求经过的渠道控制。',
      channelBillingBasisTitle: '渠道计费基准',
      channelBillingBasisHint: '控制经该渠道请求时，用请求模型名还是映射后的模型名查找价格。',
      channelBillingBasisNoChannels: '暂无渠道',
      channelBillingBasisSaved: '渠道计费基准已保存',
      channelBillingBasisLegacyUpstream: '旧值为按实际上游模型；保存后会改为按映射后模型。',
      billingModelSourceRequested: '按请求模型',
      billingModelSourceChannelMapped: '按映射后模型',

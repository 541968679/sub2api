...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	adminUserHandler := admin.NewUserHandler(adminService, concurrencyService, userPlatformQuotaServiceAdapter, billingCache, accountUsageService, userSmartScheduleService)

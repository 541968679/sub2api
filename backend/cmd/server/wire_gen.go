...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	// Inject global Antigravity default mapping override from settings table
	domain.GetAntigravityDefaultMappingOverride = func() map[string]string {
		return settingService.GetAntigravityDefaultModelMapping(context.Background())
	}
	...
	pricingPageHandler := handler.NewPricingPageHandler(globalModelPricingService, userModelPricingService, settingRepository)
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, pricingPageHandler, idempotencyCoordinator, idempotencyCleanupService)

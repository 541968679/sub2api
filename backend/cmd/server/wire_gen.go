...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	modelPricingResolver := service.NewModelPricingResolver(channelService, billingService, globalModelPricingRepository)
	...
	globalModelPricingService := service.NewGlobalModelPricingService(globalModelPricingRepository, pricingService, channelService, groupRepository)

...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountQualityMaintenanceService := service.ProvideAccountQualityMaintenanceService(accountQualitySnapshotRepository, usageLogRepository, timingWheelService, leaderLockCache, db, accountRepository, settingService, accountQualityLiveCache)
	...
	gatewayService := service.ProvideGatewayService(accountRepository, groupRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, identityService, httpUpstream, deferredService, claudeTokenProvider, sessionLimitCache, rpmCache, digestSessionStore, settingService, tlsFingerprintProfileService, channelService, modelPricingResolver, balanceNotifyService, antigravityCreditSampler, accountQualityLiveCache, userSmartScheduleService)
	...
	opsService := service.ProvideOpsService(opsRepository, settingRepository, configConfig, accountRepository, userRepository, concurrencyService, gatewayService, openAIGatewayService, geminiMessagesCompatService, antigravityGatewayService, opsSystemLogSink, settingService, userSmartScheduleService)

...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountQualityMaintenanceService := service.ProvideAccountQualityMaintenanceService(accountQualitySnapshotRepository, userQualitySnapshotRepository, usageLogRepository, timingWheelService, leaderLockCache, db, accountRepository, settingService, accountQualityLiveCache)
	...
	gatewayService := service.ProvideGatewayService(accountRepository, groupRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, identityService, httpUpstream, deferredService, claudeTokenProvider, sessionLimitCache, rpmCache, digestSessionStore, settingService, tlsFingerprintProfileService, channelService, modelPricingResolver, balanceNotifyService, antigravityCreditSampler, accountQualityLiveCache, userSmartScheduleService, accountQualityMaintenanceService)
	...
	geminiMessagesCompatService := service.ProvideGeminiMessagesCompatService(accountRepository, groupRepository, gatewayCache, schedulerSnapshotService, geminiTokenProvider, rateLimitService, httpUpstream, antigravityGatewayService, configConfig, accountQualityLiveCache, userSmartScheduleService)

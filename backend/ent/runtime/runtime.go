...
func init() {
	...
	usagelogDescImageInputTokens := usagelogFields[39].Descriptor()
	...
	usagelogDescImageQuality := usagelogFields[45].Descriptor()
	...
	userDescDownstreamUsageTokenMode := userFields[22].Descriptor()

...
func init() {
	...
	// batchimagejobDescParentBatchID is the schema descriptor for parent_batch_id field.
	batchimagejobDescParentBatchID := batchimagejobFields[7].Descriptor()
	// batchimagejob.ParentBatchIDValidator is a validator for the "parent_batch_id" field. It is called by the builders before save.
	batchimagejob.ParentBatchIDValidator = batchimagejobDescParentBatchID.Validators[0].(func(string) error)
	...
	// batchimagejobDescBaseUnitPrice is the schema descriptor for base_unit_price field.
	batchimagejobDescBaseUnitPrice := batchimagejobFields[21].Descriptor()
	// batchimagejob.DefaultBaseUnitPrice holds the default value on creation for the base_unit_price field.
	batchimagejob.DefaultBaseUnitPrice = batchimagejobDescBaseUnitPrice.Default.(float64)
	// batchimagejobDescGroupRateMultiplier is the schema descriptor for group_rate_multiplier field.
	batchimagejobDescGroupRateMultiplier := batchimagejobFields[22].Descriptor()
	// batchimagejob.DefaultGroupRateMultiplier holds the default value on creation for the group_rate_multiplier field.
	batchimagejob.DefaultGroupRateMultiplier = batchimagejobDescGroupRateMultiplier.Default.(float64)
	// batchimagejobDescAccountRateMultiplier is the schema descriptor for account_rate_multiplier field.
	batchimagejobDescAccountRateMultiplier := batchimagejobFields[23].Descriptor()
	// batchimagejob.DefaultAccountRateMultiplier holds the default value on creation for the account_rate_multiplier field.
	batchimagejob.DefaultAccountRateMultiplier = batchimagejobDescAccountRateMultiplier.Default.(float64)
	// batchimagejobDescBatchDiscountMultiplier is the schema descriptor for batch_discount_multiplier field.
	batchimagejobDescBatchDiscountMultiplier := batchimagejobFields[24].Descriptor()
	// batchimagejob.DefaultBatchDiscountMultiplier holds the default value on creation for the batch_discount_multiplier field.
	batchimagejob.DefaultBatchDiscountMultiplier = batchimagejobDescBatchDiscountMultiplier.Default.(float64)
	// batchimagejobDescHoldMultiplier is the schema descriptor for hold_multiplier field.
	batchimagejobDescHoldMultiplier := batchimagejobFields[25].Descriptor()
	// batchimagejob.DefaultHoldMultiplier holds the default value on creation for the hold_multiplier field.
	batchimagejob.DefaultHoldMultiplier = batchimagejobDescHoldMultiplier.Default.(float64)
	// batchimagejobDescBillableUnitPrice is the schema descriptor for billable_unit_price field.
	batchimagejobDescBillableUnitPrice := batchimagejobFields[26].Descriptor()
	// batchimagejob.DefaultBillableUnitPrice holds the default value on creation for the billable_unit_price field.
	batchimagejob.DefaultBillableUnitPrice = batchimagejobDescBillableUnitPrice.Default.(float64)
	// batchimagejobDescHoldUnitPrice is the schema descriptor for hold_unit_price field.
	batchimagejobDescHoldUnitPrice := batchimagejobFields[27].Descriptor()
	// batchimagejob.DefaultHoldUnitPrice holds the default value on creation for the hold_unit_price field.
	batchimagejob.DefaultHoldUnitPrice = batchimagejobDescHoldUnitPrice.Default.(float64)
	// batchimagejobDescPricingSnapshotVersion is the schema descriptor for pricing_snapshot_version field.
	batchimagejobDescPricingSnapshotVersion := batchimagejobFields[28].Descriptor()
	// batchimagejob.DefaultPricingSnapshotVersion holds the default value on creation for the pricing_snapshot_version field.
	batchimagejob.DefaultPricingSnapshotVersion = batchimagejobDescPricingSnapshotVersion.Default.(int)
	// batchimagejobDescCurrency is the schema descriptor for currency field.
	batchimagejobDescCurrency := batchimagejobFields[29].Descriptor()
	...
	batchimagejobDescHoldID := batchimagejobFields[30].Descriptor()
	...
	batchimagejobDescIdempotencyKey := batchimagejobFields[31].Descriptor()
	...
	batchimagejobDescRequestHash := batchimagejobFields[32].Descriptor()
	...
	batchimagejobDescManifestHash := batchimagejobFields[33].Descriptor()
	...
	batchimagejobDescRetryCount := batchimagejobFields[34].Descriptor()
	...
	batchimagejobDescVersion := batchimagejobFields[35].Descriptor()
	...
	batchimagejobDescLastErrorCode := batchimagejobFields[41].Descriptor()
	...
	batchimagejobDescCreatedAt := batchimagejobFields[43].Descriptor()
	...
	batchimagejobDescUpdatedAt := batchimagejobFields[44].Descriptor()
	...
	groupDescBlockedModels := groupFields[40].Descriptor()
	...
	groupDescAllowedModels := groupFields[41].Descriptor()
	...
	imagechannelmonitorFields := schema.ImageChannelMonitor{}.Fields()
	_ = imagechannelmonitorFields
	// imagechannelmonitorDescName is the schema descriptor for name field.
	imagechannelmonitorDescName := imagechannelmonitorFields[0].Descriptor()
	// imagechannelmonitor.NameValidator is a validator for the "name" field. It is called by the builders before save.
	imagechannelmonitor.NameValidator = func() func(string) error {
		validators := imagechannelmonitorDescName.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// imagechannelmonitorDescEndpoint is the schema descriptor for endpoint field.
	imagechannelmonitorDescEndpoint := imagechannelmonitorFields[2].Descriptor()
	// imagechannelmonitor.DefaultEndpoint holds the default value on creation for the endpoint field.
	imagechannelmonitor.DefaultEndpoint = imagechannelmonitorDescEndpoint.Default.(string)
	// imagechannelmonitor.EndpointValidator is a validator for the "endpoint" field. It is called by the builders before save.
	imagechannelmonitor.EndpointValidator = imagechannelmonitorDescEndpoint.Validators[0].(func(string) error)
	// imagechannelmonitorDescAPIKeyEncrypted is the schema descriptor for api_key_encrypted field.
	imagechannelmonitorDescAPIKeyEncrypted := imagechannelmonitorFields[3].Descriptor()
	// imagechannelmonitor.DefaultAPIKeyEncrypted holds the default value on creation for the api_key_encrypted field.
	imagechannelmonitor.DefaultAPIKeyEncrypted = imagechannelmonitorDescAPIKeyEncrypted.Default.(string)
	// imagechannelmonitorDescAccountName is the schema descriptor for account_name field.
	imagechannelmonitorDescAccountName := imagechannelmonitorFields[5].Descriptor()
	// imagechannelmonitor.DefaultAccountName holds the default value on creation for the account_name field.
	imagechannelmonitor.DefaultAccountName = imagechannelmonitorDescAccountName.Default.(string)
	// imagechannelmonitor.AccountNameValidator is a validator for the "account_name" field. It is called by the builders before save.
	imagechannelmonitor.AccountNameValidator = imagechannelmonitorDescAccountName.Validators[0].(func(string) error)
	// imagechannelmonitorDescProxyName is the schema descriptor for proxy_name field.
	imagechannelmonitorDescProxyName := imagechannelmonitorFields[7].Descriptor()
	// imagechannelmonitor.DefaultProxyName holds the default value on creation for the proxy_name field.
	imagechannelmonitor.DefaultProxyName = imagechannelmonitorDescProxyName.Default.(string)
	// imagechannelmonitor.ProxyNameValidator is a validator for the "proxy_name" field. It is called by the builders before save.
	imagechannelmonitor.ProxyNameValidator = imagechannelmonitorDescProxyName.Validators[0].(func(string) error)
	// imagechannelmonitorDescModel is the schema descriptor for model field.
	imagechannelmonitorDescModel := imagechannelmonitorFields[8].Descriptor()
	// imagechannelmonitor.ModelValidator is a validator for the "model" field. It is called by the builders before save.
	imagechannelmonitor.ModelValidator = func() func(string) error {
		validators := imagechannelmonitorDescModel.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// imagechannelmonitorDescPrompt is the schema descriptor for prompt field.
	imagechannelmonitorDescPrompt := imagechannelmonitorFields[9].Descriptor()
	// imagechannelmonitor.PromptValidator is a validator for the "prompt" field. It is called by the builders before save.
	imagechannelmonitor.PromptValidator = func() func(string) error {
		validators := imagechannelmonitorDescPrompt.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// imagechannelmonitorDescSize is the schema descriptor for size field.
	imagechannelmonitorDescSize := imagechannelmonitorFields[10].Descriptor()
	// imagechannelmonitor.DefaultSize holds the default value on creation for the size field.
	imagechannelmonitor.DefaultSize = imagechannelmonitorDescSize.Default.(string)
	// imagechannelmonitor.SizeValidator is a validator for the "size" field. It is called by the builders before save.
	imagechannelmonitor.SizeValidator = imagechannelmonitorDescSize.Validators[0].(func(string) error)
	// imagechannelmonitorDescQuality is the schema descriptor for quality field.
	imagechannelmonitorDescQuality := imagechannelmonitorFields[11].Descriptor()
	// imagechannelmonitor.DefaultQuality holds the default value on creation for the quality field.
	imagechannelmonitor.DefaultQuality = imagechannelmonitorDescQuality.Default.(string)
	// imagechannelmonitor.QualityValidator is a validator for the "quality" field. It is called by the builders before save.
	imagechannelmonitor.QualityValidator = imagechannelmonitorDescQuality.Validators[0].(func(string) error)
	// imagechannelmonitorDescN is the schema descriptor for n field.
	imagechannelmonitorDescN := imagechannelmonitorFields[12].Descriptor()
	// imagechannelmonitor.DefaultN holds the default value on creation for the n field.
	imagechannelmonitor.DefaultN = imagechannelmonitorDescN.Default.(int)
	// imagechannelmonitor.NValidator is a validator for the "n" field. It is called by the builders before save.
	imagechannelmonitor.NValidator = imagechannelmonitorDescN.Validators[0].(func(int) error)
	// imagechannelmonitorDescDownloadImage is the schema descriptor for download_image field.
	...
	imagechannelmonitor.UpdateDefaultUpdatedAt = imagechannelmonitorDescUpdatedAt.UpdateDefault.(func() time.Time)
	imagechannelmonitorhistoryFields := schema.ImageChannelMonitorHistory{}.Fields()
	_ = imagechannelmonitorhistoryFields
	// imagechannelmonitorhistoryDescHasURL is the schema descriptor for has_url field.
	imagechannelmonitorhistoryDescHasURL := imagechannelmonitorhistoryFields[7].Descriptor()
	// imagechannelmonitorhistory.DefaultHasURL holds the default value on creation for the has_url field.
	imagechannelmonitorhistory.DefaultHasURL = imagechannelmonitorhistoryDescHasURL.Default.(bool)
	// imagechannelmonitorhistoryDescHasB64JSON is the schema descriptor for has_b64_json field.
	...
	// paymentorderDescCreditAmount is the schema descriptor for credit_amount field.
	paymentorderDescCreditAmount := paymentorderFields[6].Descriptor()
	// paymentorder.DefaultCreditAmount holds the default value on creation for the credit_amount field.
	paymentorder.DefaultCreditAmount = paymentorderDescCreditAmount.Default.(float64)
	...
	// paymentorderDescMemberGroupIds is the schema descriptor for member_group_ids field.
	paymentorderDescMemberGroupIds := paymentorderFields[19].Descriptor()
	// paymentorder.DefaultMemberGroupIds holds the default value on creation for the member_group_ids field.
	paymentorder.DefaultMemberGroupIds = paymentorderDescMemberGroupIds.Default.([]int64)
	...
	// subscriptionplanDescMemberGroupIds is the schema descriptor for member_group_ids field.
	subscriptionplanDescMemberGroupIds := subscriptionplanFields[1].Descriptor()
	// subscriptionplan.DefaultMemberGroupIds holds the default value on creation for the member_group_ids field.
	subscriptionplan.DefaultMemberGroupIds = subscriptionplanDescMemberGroupIds.Default.([]int64)
	...
	// usagelogDescLongContextApplied is the schema descriptor for long_context_applied field.
	usagelogDescLongContextApplied := usagelogFields[26].Descriptor()
	// usagelog.DefaultLongContextApplied holds the default value on creation for the long_context_applied field.
	usagelog.DefaultLongContextApplied = usagelogDescLongContextApplied.Default.(bool)
	...
	usagelogDescImageQuality := usagelogFields[43].Descriptor()
	...
	userDescDownstreamUsageTokenMode := userFields[21].Descriptor()

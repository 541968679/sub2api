...
type SubscriptionPlan struct {
	...
	// Additional bundled subscription group IDs; empty = single-group plan
	...
	// Display currency label for plan prices (e.g. USD, CNY); empty keeps historical UI
...
func (*SubscriptionPlan) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case subscriptionplan.FieldMemberGroupIds:
			values[i] = new([]byte)

...
type UsageLog struct {
	...
	// LongContextApplied holds the value of the "long_context_applied" field.
	LongContextApplied bool `json:"long_context_applied,omitempty"`
	// LongContextInputThreshold holds the value of the "long_context_input_threshold" field.
	...
	// TrueFirstTokenMs holds the value of the "true_first_token_ms" field.
	...
	// Generated video count; positive values identify video usage
	VideoCount int `json:"video_count,omitempty"`
	// Video billing resolution: 480p, 720p, or 1080p
	VideoResolution *string `json:"video_resolution,omitempty"`
	// Billable duration per generated video in seconds
	...
	for i := range columns {
		...
		case usagelog.FieldLongContextApplied:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field long_context_applied", values[i])
			} else if value.Valid {
				_m.LongContextApplied = value.Bool
			}
		...
		case usagelog.FieldTrueFirstTokenMs:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field true_first_token_ms", values[i])
			} else if value.Valid {
				_m.TrueFirstTokenMs = new(int)
				*_m.TrueFirstTokenMs = int(value.Int64)
			}
...
func (_m *UsageLog) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("long_context_applied=")
	builder.WriteString(fmt.Sprintf("%v", _m.LongContextApplied))
	builder.WriteString(", ")
	...
	builder.WriteString(", ")
	if v := _m.TrueFirstTokenMs; v != nil {
		builder.WriteString("true_first_token_ms=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")

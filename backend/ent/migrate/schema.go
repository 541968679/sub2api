...
var (
	...
	BatchImageJobsColumns = []*schema.Column{
		...
		{Name: "parent_batch_id", Type: field.TypeString, Nullable: true, Size: 64},
		...
		{Name: "account_rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "batch_discount_multiplier", Type: field.TypeFloat64, Default: 0.5, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "hold_multiplier", Type: field.TypeFloat64, Default: 0.6, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "billable_unit_price", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "hold_unit_price", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "pricing_snapshot_version", Type: field.TypeInt, Default: 0},
	...
	BatchImageJobsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{BatchImageJobsColumns[2], BatchImageJobsColumns[44]},
			},
			{
			...
			{
				Name:    "batchimagejob_parent_batch_id",
				Unique:  false,
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "ccs_import_model_picker_enabled", Type: field.TypeBool, Default: false},
		{Name: "ccs_import_default_model", Type: field.TypeString, Size: 100, Default: ""},
		{Name: "messages_dispatch_model_config", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "models_list_config", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "rpm_limit", Type: field.TypeInt, Default: 0},
		{Name: "blocked_models", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "credit_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,6)"}},
		...
		{Name: "member_group_ids", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
	...
	ProxiesColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
		{Name: "pool_enabled", Type: field.TypeBool, Default: false},
	}
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "long_context_applied", Type: field.TypeBool, Default: false},
		...
		{Name: "true_first_token_ms", Type: field.TypeInt, Nullable: true},
		...
		{Name: "image_quality", Type: field.TypeString, Nullable: true, Size: 20},
		...
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "true_cost", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "true_cost_rate", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[52], UsageLogsColumns[46]},
			},
			{
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "rpm_limit", Type: field.TypeInt, Default: 0},
		{Name: "downstream_usage_token_mode", Type: field.TypeString, Size: 20, Default: "display"},
		{Name: "display_cache_token_max_mult", Type: field.TypeFloat64, Nullable: true},
	}
	...
	UserSmartScheduleAccountsTable = &schema.Table{
		...
		PrimaryKey: []*schema.Column{UserSmartScheduleAccountsColumns[5], UserSmartScheduleAccountsColumns[4]},
		ForeignKeys: []*schema.ForeignKey{
			{
			...
			},
			{
				...
				Columns:    []*schema.Column{UserSmartScheduleAccountsColumns[5]},
				RefColumns: []*schema.Column{AccountsColumns[0]},
				OnDelete:   schema.NoAction,
			},
		},
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UserSmartScheduleAccountsColumns[4], UserSmartScheduleAccountsColumns[1]},
			},
			{

...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			aicreditsnapshot.Table:              aicreditsnapshot.ValidColumn,
			apikey.Table:                        apikey.ValidColumn,
			account.Table:                       account.ValidColumn,
			accountgroup.Table:                  accountgroup.ValidColumn,
			accountqualitysnapshot.Table:        accountqualitysnapshot.ValidColumn,
			accountscheduleuser.Table:           accountscheduleuser.ValidColumn,
			...
			imagechannelmonitor.Table:           imagechannelmonitor.ValidColumn,
			imagechannelmonitorhistory.Table:    imagechannelmonitorhistory.ValidColumn,

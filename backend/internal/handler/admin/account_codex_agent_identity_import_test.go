...
func newAgentIdentityAccountHandlerForTest(svc service.AdminService) *AccountHandler {
	return NewAccountHandler(svc, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
}
...
func TestImportCodexSessionsCreatesAgentIdentityWithoutOAuthExpiry(t *testing.T) {
	...
	handler := newAgentIdentityAccountHandlerForTest(svc)

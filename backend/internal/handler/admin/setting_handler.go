...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		RegistrationApprovalRequired:                           settings.RegistrationApprovalRequired,
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		RegistrationApprovalRequired:     req.RegistrationApprovalRequired,
		...
		OpenAIAdvancedSchedulerStickyWeightedEnabled:       boolSetting(req.OpenAIAdvancedSchedulerStickyWeightedEnabled, previousSettings.OpenAIAdvancedSchedulerStickyWeightedEnabled),
		OpenAIAdvancedSchedulerSubscriptionPriorityEnabled: boolSetting(req.OpenAIAdvancedSchedulerSubscriptionPriorityEnabled, previousSettings.OpenAIAdvancedSchedulerSubscriptionPriorityEnabled),
	...
	payload := dto.SystemSettings{
		...
		RegistrationApprovalRequired:                           updatedSettings.RegistrationApprovalRequired,
		...
		TutorialURL:                                            updatedSettings.TutorialURL,
...
func hasPaymentFields(req UpdateSettingsRequest) bool {
	return req.PaymentEnabled != nil || req.PaymentMinAmount != nil ||
		...
		req.PaymentBalanceRechargeMultiplier != nil || req.PaymentSubscriptionUSDToCNYRate != nil || req.PaymentRechargeFeeRate != nil ||
...
func diffSettings(before *service.SystemSettings, after *service.SystemSettings, beforeAuthSourceDefaults *service.AuthSourceDefaultSettings, afterAuthSourceDefaults *service.AuthSourceDefaultSettings, req UpdateSettingsRequest) []string {
	...
	if before.RegistrationApprovalRequired != after.RegistrationApprovalRequired {
		changed = append(changed, "registration_approval_required")
	}
	...
	if before.TutorialURL != after.TutorialURL {
		changed = append(changed, "tutorial_url")
	}
	...
	schedulerStrings := []struct{ name, before, after string }{
	...
	for _, field := range schedulerStrings {

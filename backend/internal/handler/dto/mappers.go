...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	out := &Account{
		...
		UpstreamRateMultiplier:  a.EffectiveUpstreamRate(),
		Status:                  a.Status,
		...
		PublicSchedulable:       a.AllowsPublicSchedule(),
...
func redeemCodeFromServiceBase(rc *service.RedeemCode) RedeemCode {
	out := RedeemCode{
		...
		BatchID:                 rc.BatchID,
		BatchRedeemLimitPerUser: rc.BatchRedeemLimitPerUser,
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		DisplayTokenCapApplied:      l.DisplayTokenCapApplied,
		DisplayContextTokenMaxUsed:  l.DisplayContextTokenMaxUsed,
		DisplayOutputTokenMaxUsed:   l.DisplayOutputTokenMaxUsed,

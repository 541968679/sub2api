...
func ProvideGrokTokenProvider(
	...
	provider.SetRefreshAPI(refreshAPI, NewGrokTokenRefresher(grokOAuthService))
	provider.SetRefreshPolicy(AntigravityProviderRefreshPolicy())
...
func ProvideSubscriptionExpiryService(userSubRepo UserSubscriptionRepository, lockCache LeaderLockCache, db *sql.DB) *SubscriptionExpiryService {
...
func ProvideRateLimitService(
	...
	svc.SetOAuthFleetSoft429Cache(oauthFleetSoft429Cache)
	return svc
}
...
// type instead of raw []byte, avoiding Wire ambiguity.

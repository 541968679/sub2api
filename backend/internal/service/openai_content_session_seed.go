...
// are included: model, tools/functions definitions, the leading
// system/developer prompt prefix in Chat messages, instructions (Responses
// API), and the first user message.

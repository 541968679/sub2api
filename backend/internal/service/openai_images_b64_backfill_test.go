...
func TestIsBackfillImageContent(t *testing.T) {
	...
	require.True(t, isBackfillImageContent(b64BackfillPNGBytes))
	require.True(t, isBackfillImageContent([]byte{0xFF, 0xD8, 0xFF, 0xE0, 0x00, 0x10, 'J', 'F', 'I', 'F', 0x00}))
	require.True(t, isBackfillImageContent(webp))
	require.True(t, isBackfillImageContent([]byte("GIF89a\x01\x00\x01\x00")))
	require.False(t, isBackfillImageContent([]byte("BM\x00\x00\x00\x00\x00\x00\x00\x00")))
	require.False(t, isBackfillImageContent([]byte("<html>login required</html>")))
	require.False(t, isBackfillImageContent(nil))
}

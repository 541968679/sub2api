...
const (
	...
	BillingModeVideo      BillingMode = "video"       // Video generation billed per second
)
...
type ChannelUsageFields struct {
	...
	OpenAIClaudeGPTBridge bool   // Marks Antigravity Claude-GPT bridge usage for diagnostics.
}

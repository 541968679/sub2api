...
const (
	AccountAutoProvisionModeTemplate        = "template"
	AccountAutoProvisionModeCloneLastHealth = "clone_last_healthy"
)
...
type AccountAutoProvisionState struct {
	...
	LastHealthySnapshots map[string]AccountAutoProvisionSnapshot `json:"last_healthy_snapshots,omitempty"`
	RecentLogs           []AccountAutoProvisionLogEntry          `json:"recent_logs,omitempty"`
}
...
func DefaultAccountAutoProvisionSettings() *AccountAutoProvisionSettings {
	return &AccountAutoProvisionSettings{
		Enabled:              false,
...
func DefaultAccountAutoProvisionState() *AccountAutoProvisionState {
	return &AccountAutoProvisionState{
		LastTriggered:        map[string]time.Time{},
		LastHealthySnapshots: map[string]AccountAutoProvisionSnapshot{},
		RecentLogs:           []AccountAutoProvisionLogEntry{},
	}
}
